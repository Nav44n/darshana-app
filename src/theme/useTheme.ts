import { colors, fonts as staticFonts, type, gunaStops, getElevation, getSystemAccent, auroraStops, glowText } from './tokens';
...
export function useTheme() {
  return {
    ...
    elevation: (level: 1 | 2 | 3 = 1) => getElevation('dark', level),
    glowText,
  };
}
