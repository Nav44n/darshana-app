...
export const samkhyaKarikaEn: any[] = [
  {
    "id": "1",
    "number": "1",
    "section": "Why Inquire",
    "devanagari": "दुःखत्रयाभिघाताज्जिज्ञासा तदभिघातके हेतौ ।\nदृष्टे सा‌ऽप्यार्था चेन्नैकान्तात्यन्ततोऽभावात् ॥ १ ॥",
    "iast": "duḥkha-trayā-bhighātāj-jijñāsā tadabhighātake hetau |\ndṛṣṭe sa'-pārthā cen-nai-kāntā-'tyantato'-bhāvāt ||",
    "diagramId": "duhkha-traya",
    "conceptIds": [
      "duhkha-traya"
    ],
    "interpretiveNotes": [
    ...
    "translation": "Bound beings in this world are afflicted by three-fold suffering: from within oneself (ādhyātmika), from other beings (ādhibhautika), and from divine or supernatural forces (ādhidaivika). Thus arises the desire to inquire into the means of ending it. If it is argued that visible remedies (like medicines) exist and inquiry is unnecessary — no, because such worldly means cannot remove suffering with absolute certainty and permanence.",
    "commentary": "The opening verse establishes the practical motive for the entire system: the permanent destruction of suffering. Earthly remedies—like medicine for diseases or worldly wealth—can only provide temporary relief. Because the affliction can always return, these ordinary methods are neither absolute (ekānta) nor permanent (atyantato). Thus, a higher philosophical inquiry is required.",
    "keyPoints": [
      "Ādhyātmika — bodily or mental pain, e.g. disease, sorrow.",
      "Ādhibhautika — affliction caused by acts of men and animals, e.g. snake-bite, bodily hurt.",
      "Ādhidaivika — affliction caused by acts of God or supernatural causes, e.g. death by lightning.",
      "Known remedies are uncertain and cannot remove the root cause, so the same misery can return."
    ]
  },
  {
    "id": "2",
    ...
    "keyPoints": [
      "Vedic sacrifice can lead to heaven, but heaven is graded by merit — where there is difference, there is discontent.",
      "Enjoyment in heaven is exhausted and one returns to a life of misery as before.",
      "Vyakta and Avyakta are defined in Kārikā 10; Jña denotes the conscious Puruṣa, called Pumān in Kārikā 11.",
      "The word vijñāna signals the method of the whole text: direct discriminative knowledge, not mere information."
    ]
  },
  {
    "id": "3",
    "number": "3",
    "section": "The Twenty-Five Principles",
    "devanagari": "मूलप्रकृतिरविकृतिर्महदाद्याः प्रकृतिविकृतयः सप्त ।\nषोडशकस्तु विकारो न प्रकृतिर्न विकृतिः पुरुषः ॥ ३ ॥",
    "iast": "mūlaprakṛtir-avikṛtir-mahadādyāḥ prakṛti-vikṛtayaḥ sapta |\nṣoḍaśakas-tu vikāro na prakṛtir-na vikṛtiḥ puruṣaḥ ||",
    "diagramId": "tattva-tree",
    "conceptIds": [
      "twenty-five-tattvas"
    ],
    "translation": "Primordial Nature (Mūlaprakṛti) is not a modification (it has no cause). The seven principles—Mahat (intellect), Ahaṃkāra (ego), and the five subtle elements—are both nature (causes) and modifications (effects). The sixteen principles (the mind, ten organs, and five gross elements) are only modifications (effects). Puruṣa (pure consciousness) is neither a cause nor an effect.",
    "commentary": "This verse outlines the entire 25-tattva structure of the Sāṃkhya universe. The root cause of the universe, Prakṛti, is uncaused. The next seven evolutes are both effects of what came before them and causes of what comes after. The final sixteen evolutes are purely effects; they do not generate any further categories. Puruṣa stands completely outside this causal chain, being neither a producer nor a product.",
    "keyPoints": [
      "The seven producer-products: Mahat (Buddhi), Ahaṃkāra, and the five Tanmātras.",
      "The sixteen pure products: the five Mahābhūtas, the ten sense-organs (five jñānendriya + five karmendriya), and manas.",
      "Together with Prakṛti these twenty-four Tattvas, plus Puruṣa, make the full count of twenty-five.",
      "Puruṣa and root-Prakṛti alone are causeless; everything else stands somewhere in the chain of cause and effect."
    ]
  },
  {
    "id": "4",
    "number": "4",
    "section": "Pramāṇas — Means of Knowledge",
    "devanagari": "दृष्टमनुमानमाप्तवचनं च, सर्वप्रमाणसिद्धत्वात् ।\nत्रिविधम्प्रमाणमिष्टं, प्रमेयसिद्धिः प्रमाणाद्धि ॥ ४ ॥",
    "iast": "dṛṣṭam-anumānam-āptavacanam ca, sarvapramāṇa-siddhatvāt |\ntrividham pramāṇam iṣṭam, prameyasiddhiḥ pramāṇād-dhi ||",
    "diagramId": "pramanas-diagram",
    "conceptIds": [
      "pramanas"
    ],
    "translation": "There are only three means of knowledge: direct perception (dṛṣṭa), logical inference (anumāna), and valid testimony (āptavacana). Every other proposed means of knowledge is fully encompassed within these three. It is through these three pramāṇas that the knowledge of all proven objects (prameya) is established.",
    "commentary": "Sāṃkhya officially recognizes only three valid means of knowledge (pramāṇas). It argues that additional means proposed by other schools—such as comparison (upamāna) in Nyāya—are not independent proofs, but are merely subsets of inference or perception. Importantly, by explicitly recognizing āptavacana (valid testimony), Sāṃkhya fully accepts the authority of the Vedas.",
    "keyPoints": [
      "Āpta-vacana is the testimony of one who is truthful and all-knowing, not merely secondhand report.",
      "Knowledge obtained by reading the Vedas oneself, without a speaker and a listener, is technically inference rather than āpta-vacana.",
      "Sāṃkhya explains its system through common-sense reasoning available to all people, regardless of religious faith."
    ]
  },
  {
    "id": "5",
    "number": "5",
    "section": "Pramāṇas — Means of Knowledge",
    "devanagari": "प्रतिविषयाध्यवसायो दृष्टं, विविधमनुमानमाख्यातम् ।\nतल्लिङ्गलिङ्गिपूर्वकम्, आप्तश्रुतिराप्तवचनं तु ॥ ५ ॥",
    "iast": "prati-viṣayā-dhyavasāyo dṛṣṭam, trividham-anumānam-ākhyātam |\ntal-liṅga-liṅgi-pūrvakam, āpta-śrutir-āptavacanam tu ||",
    "conceptIds": [
      "pramanas"
    ],
    "translation": "Direct cognition is the Buddhi's final ascertainment of an object. Inference, based on prior knowledge of a mark and what it signifies, is of three kinds. Āptavacana is the verbal testimony of a truthful and wise person.",
    "commentary": "The three kinds of inference are dṛṣṭavat (inferring fire from smoke seen before), śeṣavat (deducing the whole from a sample part), and sāmānyatodṛṣṭa (inductive reasoning from analogy). The word 'tu' in the verse signals that Sāṃkhya, despite its independence from scripture, still ranks trustworthy testimony as the most reliable of the three pramāṇas.",
    "keyPoints": [
      "Dṛṣṭavat — inferring an unseen cause (fire) from a seen sign (smoke), as one has before.",
      "Śeṣavat — deducing the characteristics of a whole from examining a sample part of it.",
      "Sāmānyatodṛṣṭa — inductive logic, inference from general analogy.",
      "Direct cognition is specifically the Buddhi's adhyavasāya — its act of final determination, not mere sensation."
    ]
  },
  {
    "id": "6",
    "number": "6",
    "section": "Pramāṇas — Means of Knowledge",
    "devanagari": "सामान्यतस्तु दृष्टात् अतीन्द्रियाणाम्प्रतीतिरनुमानात् ।\nतस्मादपि चासिद्धं परोक्षमाप्तागमात् सिद्धम् ॥ ६ ॥",
    "iast": "sāmānyatas-tu dṛṣṭāt atīndriyāṇām pratītir-anumānāt |\ntasmād-api cā-siddhaṃ parokṣam-āptā-gamāt siddham ||",
    "conceptIds": [
      "pramanas"
    ],
    "translation": "Knowledge of objects beyond the reach of the senses may be derived by inference based on analogy; what remains obscure even to inference may be known through āptavacana.",
    "commentary": "This verse closes the epistemology section by covering the residue: some matters — Phukan gives the example of information about the gods in heaven — cannot be reached by perception or inference at all, and can only be known from trustworthy testimony.",
    "keyPoints": [
      "Some matters can only be known through āptavacana, when even inference cannot reach them.",
      "This completes the threefold pramāṇa system before the text turns to causation."
    ]
  },
  {
    "id": "7",
    ...
    "keyPoints": [
      "The seven causes: too far, too near, damaged sense-organs, inattentive mind, extreme subtlety, obstruction, and blending with similar things.",
      "This sets up Kārikā 8's argument that Prakṛti is unperceived because it is subtle, not because it doesn't exist."
    ]
  },
  {
    "id": "8",
    "number": "8",
    "section": "Non-Perception & Causation",
    "devanagari": "सौक्ष्म्यात्तदनुपलब्धिर्नाभावात्, कार्यतस्तदुपलब्धेः ।\nमहदादि तच्च कार्यं प्रकृतिसरूपं विरूपं च ॥ ८ ॥",
    "iast": "saukṣmyāt tadanupalabdhir-nā-bhāvāt kāryatas-tadupalabdheḥ |\nmahadādi tac-ca kāryaṃ prakṛtisarūpaṃ virūpaṃ ca |",
    "conceptIds": [
      "satkaryavada"
    ],
    "translation": "Non-perception of Prakṛti is due to its subtlety, not to its non-existence — its existence can be inferred from its effects, Mahat and the rest, some of which resemble it and some of which do not.",
    "commentary": "Every effect has a cause, and the cause exists in latent form within the effect — a principle developed fully in the next verse. Mahat, Ahaṃkāra and the Tanmātras resemble Prakṛti in being unobservable; the mind, Buddhi, sense-organs and the five gross elements are, unlike Prakṛti, observable. From the full set of effects, Prakṛti's existence as their cause can reasonably be inferred.",
    "keyPoints": [
      "Non-perception has many possible causes; subtlety (not absence) explains why Prakṛti itself is never seen.",
      "Some effects of Prakṛti (Mahat, Ahaṃkāra, Tanmātras) are themselves unobservable, like their cause.",
      "Other effects (mind, Buddhi, sense-organs, the gross elements) are observable, unlike their cause."
    ]
  },
  {
    "id": "9",
    "number": "9",
    "section": "Satkāryavāda — Pre-existence of the Effect",
    "devanagari": "असदकरणादुपादानग्रहणात् सर्वसंभवाभावात् ।\nशक्तस्य शक्यकरणात्, कारणभावाच्च सत्कार्यम् ॥ ९ ॥",
    "iast": "asad-akaraṇād-upādāna-grahaṇāt sarvasambhavā-bhāvāt |\nśaktasya śakya-karaṇāt, kāraṇa-bhāvāc-ca satkāryam ||",
    "diagramId": "satkaryavada-chain",
    "conceptIds": [
      "satkaryavada"
    ],
    "translation": "The effect, even prior to its manifestation, always exists as a real entity within its cause — because nothing can be produced from what does not exist at all; because production requires the proper material cause; because not everything can be produced from anything; because a cause can only produce what it has the power to produce; and because cause and effect share an inherent, non-different nature.",
    "commentary": "This is Sāṃkhya's central causal doctrine, satkāryavāda: the effect pre-exists latently in its cause and is not a new creation from nothing. Curd only comes from milk, oil only from oil-bearing seeds, because the effect already stands in a fixed relation to its cause. Nothing happens by chance — 'chance' is only a word covering our own ignorance of the true cause. The whole universe, as stated in Kārikā 3, is a continuous unfolding of causes into their effects, tracing back to the one uncaused root cause, the Avyakta of the next verse.",
    "keyPoints": [
      "Nothing can be produced from what is as non-existent as a barren woman's son (asad-akaraṇāt).",
      "Production requires the proper material — curd from milk, not from water (upādāna-grahaṇāt).",
      "Not everything can come from anything — oil comes from seed, not sand (sarva-sambhavā-bhāvāt).",
      "A cause can only produce what lies within its power (śaktasya śakya-karaṇāt).",
      "Cause and effect share an inherent likeness, as cloth does not differ in substance from its threads (kāraṇa-bhāvāt)."
    ]
  },
  {
    "id": "10",
    ...
    "keyPoints": [
      "Nine paired attributes distinguish the Vyakta from the Avyakta — caused vs uncaused, perishable vs eternal, limited vs all-pervading, and so on.",
      "Material Vyaktas have four dimensions (three of space, one of time); Buddhi and the internal organs have only the time-dimension, changing moment to moment.",
      "Being all-pervading, the Avyakta must be one — two separate all-pervading entities cannot be conceived."
    ]
  },
  {
    "id": "11",
    ...
    "keyPoints": [
      "Prakṛti in her manifest state is triguṇa (composed of the three Guṇas), inseparable from them, non-conscious, and productive — the opposite of Puruṣa in every respect.",
      "'Aviveki' — manifest objects are nothing but assemblages of the Guṇas, inseparable from them, much as matter, in modern physics, resolves into modes of energy.",
      "The single word Pumān gave rise to a genuine interpretive disagreement among commentators over whether it denotes one Puruṣa or many."
    ]
  },
  {
    "id": "12",
    "number": "12",
    "section": "The Three Guṇas",
    "devanagari": "प्रीत्यप्रीतिविषादात्मकाः प्रकाशप्रवृत्तिनियमार्थाः ।\nअन्योन्याभिभवाश्रयजननमिथुनवृत्तयश्च गुणाः ॥ १२ ॥",
    "iast": "prīty-aprīti-viṣādā-tmakāḥ prakāśa-pravṛtti-niyamārthāḥ |\nanyonya-bhibhavā-'śraya-janana-mithuna-vṛttayaś-ca guṇāḥ ||",
    "conceptIds": [
      "three-gunas"
    ],
    "translation": "The Guṇas are of the nature of delight, sorrow, and indifference; their purposes are illumination, activity, and restraint; and they act by mutually suppressing, supporting, producing, and consorting with one another.",
    "commentary": "Kārikā 13 will give the Guṇas' individual natures through the lamp image; this verse establishes how they work as a system — always in cooperative motion, never idle, one dominant at a time with the other two in support.",
    "keyPoints": [
      "The Guṇas produce delight, sorrow, and indifference respectively (prīti, aprīti, viṣāda).",
      "Their functions are illumination, activity, and restraint.",
      "They act on each other in five ways: suppressing, supporting, producing, being produced by, and pairing with one another."
    ]
  },
  {
    "id": "13",
    "number": "13",
    "section": "The Three Guṇas",
    "devanagari": "सत्त्वं लघु प्रकाशकमिष्टमुपष्टम्भकं चलं च रजः ।\nगुरु वरणकमेव तमः प्रदीपवच्चार्थतो वृत्तिः ॥ १३ ॥",
    "iast": "sattvaṃ laghu prakāśakam iṣṭam-upaṣṭambhakaṃ calaṃ ca rajaḥ |\nguru varaṇakam eva tamaḥ pradīpavac-cā-rthato vṛttiḥ ||",
    "diagramId": "guna-lamp",
    "conceptIds": [
      "three-gunas"
    ],
    "translation": "Sattva is light and illumining; Rajas is stimulating and mobile; Tamas is heavy and restraining. Yet they act toward one goal in cooperation, like the parts of a lamp.",
    "commentary": "The lamp image is deliberate: wick, oil and flame are three opposed things — one solid, one liquid, one pure motion — that cooperate to produce a single steady light. The Guṇas are not the same as the feelings (pleasure, sorrow, delusion) they give rise to; those feelings have no existence apart from a mind, but the Guṇas exist as a matter of fact, in Prakṛti itself, and the relation between a Guṇa and the feeling it produces is one of cause and effect, taken up again in Kārikā 38.",
    "keyPoints": [
      "Wick, oil and flame cooperate to produce one light — the governing image for the three Guṇas.",
      "The Guṇas are not identical to the feelings they produce; feelings have no existence apart from a mind, Guṇas do.",
      "Guṇa and the feeling it produces are related as cause and effect (see Kārikā 38)."
    ]
  },
  {
    "id": "14",
    "number": "14",
    "section": "The Three Guṇas",
    "devanagari": "अविवेकादेः सिद्धस्त्रैगुण्यात्तद्विपर्ययाभावात् ।\nकारणगुणात्मकत्वात्कार्यस्याव्यक्तमपि सिद्धम् ॥ १४ ॥",
    "iast": "avivekyādeḥ siddhaḥ traiguṇyāt tad-viparyayā-'bhāvāt |\nkāraṇa-guṇā-'tmakatvāt kāryasyā-'vyaktam api siddham |",
    "conceptIds": [
      "three-gunas"
    ],
    "translation": "The attributes named in Kārikā 11 — inseparableness, objectivity, non-consciousness and the rest — follow from the Vyakta being wholly composed of the three Guṇas, and could not exist otherwise; and since an effect shares the nature of its cause, we can know that the Avyakta too must contain these Guṇas, in latent form.",
    "commentary": "This is one of the pivotal kārikās: it explains how non-consciousness could come into the world at all. Take away the Guṇas, and the entire space and everything it contains vanishes at once — only the conscious Avyakta remains, itself the sole cause of creation, including the Guṇas.",
    "keyPoints": [
      "Every attribute of the Vyakta traces back to its being made entirely of the three Guṇas.",
      "Because effect and cause share one nature, the Guṇas must exist latently in the Avyakta even before manifestation.",
      "Remove the Guṇas conceptually, and the manifest world dissolves, leaving only the Avyakta."
    ]
  },
  {
    "id": "15",
    ...
    "keyPoints": [
      "Every finite, diverse thing is caused, and tracing causes back leads to one uncaused cause.",
      "All objects share the underlying sameness of being composed of the three Guṇas.",
      "At dissolution, effects merge back into their causes in the reverse order of their emergence, ending in the Avyakta."
    ]
  },
  {
    "id": "16",
    ...
    "keyPoints": [
      "The Guṇas do not create diversity out of nothing — they differentiate through contact, the way one water gives many tastes through many plants.",
      "The Tanmātras are described as bare, undifferentiated energy; observable diversity arises only where they meet a specific substance."
    ]
  },
  {
    "id": "17",
    ...
    "keyPoints": [
      "Order and useful arrangement in an assemblage of inanimate things implies an intelligent organizer, just as a car implies a driver.",
      "The organizer must be the reverse of what is organized: conscious where the arrangement is non-conscious.",
      "The desire for absolute release (named in Kārikā 1) cannot belong to Buddhi, since Buddhi cannot desire its own end."
    ]
  },
  {
    "id": "18",
    ...
    "keyPoints": [
      "Different birth, death, and sense-activity for different people are the evidence offered for plurality of Puruṣas.",
      "This directly answers the ambiguity left open by the word Pumān in Kārikā 11."
    ]
  },
  {
    "id": "19",
    ...
    "keyPoints": [
      "Puruṣa's four defining marks: witness only (sākṣī), standing apart (kaivalya), impartial (mādhyasthya), a Seer without doership (draṣṭā, akartā).",
      "This resolves the free-will question: action arises from the Saṃskāra/Buddhi, never from the inactive Puruṣa itself."
    ]
  },
  {
    "id": "20",
    ...
    "keyPoints": [
      "Buddhi 'borrows' apparent consciousness from its connection (saṃyoga) with Puruṣa.",
      "This mutual reflection is why an inactive Puruṣa nonetheless experiences itself as an agent."
    ]
  },
  {
    "id": "21",
    "number": "21",
    "section": "Saṃyoga — the Union of Puruṣa and Prakṛti",
    "devanagari": "पुरुषस्य दर्शनार्थं कैवल्यार्थं तथा प्रधानस्य ।\nपङ्ग्वन्धवदुभयोरपि संयोगस्तत्कृतः सर्गः ॥ २१ ॥",
    "iast": "puruṣasya darśanārthaṃ kaivalyārthaṃ tathā pradhānasya |\npaṅgv-andhavad ubhayor-api saṃyogas-tatkṛtaḥ sargaḥ |",
    "diagramId": "purusha-prakriti-union",
    "conceptIds": [
      "purusha-prakriti-union"
    ],
    "translation": "The union of Pradhāna with Puruṣa is for the twin purpose of Puruṣa's contemplation of Prakṛti and Prakṛti's release of Puruṣa into kaivalya — like the association of a lame man and a blind man. This union is what produces creation.",
    "commentary": "The famous lame-and-blind analogy: two men, each incomplete alone, travel together toward a common goal and part once it is reached. Puruṣa and Prakṛti's association is as old as the world itself, yet — unlike fire and its heat — it is not an inseparable connection; in deep, dreamless sleep we are already, briefly, apart from Prakṛti.",
    "keyPoints": [
      "The union serves two purposes at once: Puruṣa comes to see Prakṛti, and Prakṛti works toward Puruṣa's release.",
      "The analogy: a blind man (strength, no sight) carries a lame man (sight, no strength) toward a shared destination, then they part.",
      "This union is not an inseparable natural bond like fire and heat — it exists for a purpose and ends when that purpose is served."
    ]
  },
  {
    "id": "22",
    "number": "22",
    "section": "Evolution of the Tattvas",
    "devanagari": "प्रकृतेर्महांस्ततोऽहङ्कारस्तस्माद्गणश्च षोडशकः ।\nतस्मादपि षोडशकात्पञ्चभ्यः पञ्च भूतानि ॥ २२ ॥",
    "iast": "prakṛter-mahāṃs-tato-'haṃkāras-tasmād-gaṇaś-ca ṣodaśakaḥ |\ntasmād-api ṣodaśakāt pañcabhyaḥ pañca bhūtāni |",
    "diagramId": "tattva-tree",
    "conceptIds": [
      "twenty-five-tattvas"
    ],
    "translation": "From Prakṛti proceeds Mahat; from that, Ahaṃkāra; from that, the aggregate of sixteen (the eleven organs including mind, and the five Tanmātras); and from five of that sixteen, the five gross elements.",
    "commentary": "This is the evolutionary sequence stated as a single formula, elaborating the skeleton already given in Kārikā 3: Prakṛti → Mahat/Buddhi → Ahaṃkāra → the sixteen (eleven sense-and-action organs plus mind, and five Tanmātras) → the five Mahābhūtas from the Tanmātras.",
    "keyPoints": [
      "The evolutionary chain in one line: Prakṛti → Mahat → Ahaṃkāra → the sixteen → the five gross elements.",
      "These are described as the complete ingredients of the sense-world under inquiry."
    ]
  },
  {
    "id": "23",
    "number": "23",
    "section": "Buddhi",
    "devanagari": "अध्यवसायो बुद्धिर्धर्मो ज्ञानं विराग ऐश्वर्यम् ।\nसात्त्विकमेतद्रूपं तामसमस्माद्विपर्यस्तम् ॥ २३ ॥",
    ...
    "keyPoints": [
      "Buddhi's eight forms: jñāna (wisdom), dharma (virtue), virāga (non-attachment), and aiśvarya (power) in their Sāttvika mode; their reverses in Tāmasa mode.",
      "Aiśvarya (God-like power) is itself of eight kinds — the eight siddhis of yoga, e.g. aṇimā (entering all things) and laghimā (rising into the sky).",
      "The 'fruit of action' Sāṃkhya cares about is not karmic consequence in the world, but the reshaping of one's own Buddhi by every thought and act."
    ]
  },
  {
    "id": "24",
    ...
    "keyPoints": [
      "Ahaṃkāra branches into two creations: the eleven (mind + ten organs) and the five Tanmātras.",
      "Thoughts, in Sāṃkhya, are treated as a subtle form of energy — which is why a 'thought' of the Buddhi can generate material organs."
    ]
  },
  {
    "id": "25",
    ...
    "keyPoints": [
      "Ahaṃkāra has three modes: Vaikṛta/Sāttvika → the eleven organs; Bhūtādi/Tāmasa → the five Tanmātras; Taijasa/Rājasika → the activating force behind both."
    ]
  },
  {
    "id": "26",
    ...
    "keyPoints": [
      "Five organs of cognition: eye, ear, nose, tongue, skin.",
      "Five organs of action: voice, hands, feet, organs of excretion and generation."
    ]
  },
  {
    "id": "27",
    ...
    "keyPoints": [
      "Manas is counted among the Indriyas because it shares the function of both cognition and action.",
      "Variety among organs and variety in the external world are both attributed to the differential working of the Guṇas."
    ]
  },
  {
    "id": "28",
    ...
    "keyPoints": [
      "Cognition begins as bare, indeterminate sensory awareness (ālocana) before Buddhi assigns it meaning.",
      "The five actions of the karmendriyas: speaking, grasping, moving, excreting, and reproducing/enjoying."
    ]
  },
  {
    "id": "29",
    ...
    "keyPoints": [
      "Buddhi determines, Ahaṃkāra individuates, Manas deliberates — three distinct internal functions.",
      "The five Prāṇas are the shared, common function underlying every organ's activity."
    ]
  },
  {
    "id": "30",
    ...
    "keyPoints": [
      "Perceiving a snake and fleeing feels simultaneous — sensing, deliberating, and deciding compress together.",
      "Recognizing danger gradually, sound by sound and detail by detail, shows the same organs working in visible sequence.",
      "Cognition of absent things relies on prior perception already stored — one cannot imagine a taste never before tasted."
    ]
  },
  {
    "id": "31",
    ...
    "keyPoints": [
      "The thirteen organs (three internal, ten external) coordinate automatically, without any external operator.",
      "Their shared purpose is Puruṣārtha — the enjoyment and release of Puruṣa."
    ]
  },
  {
    "id": "32",
    ...
    "keyPoints": [
      "Thirteen organs total: ten external plus the three internal (Buddhi, Ahaṃkāra, Manas).",
      "Three functions divide across them: carrying and holding (organs of action), illumining (organs of cognition)."
    ]
  },
  {
    "id": "33",
    ...
    "keyPoints": [
      "The ten external organs act only in the present; the three internal organs range freely across past, present, and future.",
      "Sāṃkhya treats astronomical time as a mental construction arising from sequential experience, not an independent substance — Phukan compares this to relativistic space-time."
    ]
  },
  {
    "id": "34",
    ...
    "keyPoints": [
      "Ordinary human perception reaches only the differentiated Viśeṣas (the five gross elements), not the undifferentiated Tanmātras themselves.",
      "Speech is singled out as having sound alone as its object, unlike the other action-organs."
    ]
  },
  {
    "id": "35",
    ...
    "keyPoints": [
      "The sense-organs are apertures; Buddhi is the door-keeper that turns raw sensation into actual cognition."
    ]
  },
  {
    "id": "36",
    ...
    "keyPoints": [
      "The organs, though mutually unlike, cooperate like parts of a single lamp to bring experience to Buddhi."
    ]
  },
  {
    "id": "37",
    ...
    "keyPoints": [
      "Buddhi is both the instrument of Puruṣa's experience and, eventually, the instrument of Puruṣa's discriminative liberation."
    ]
  },
  {
    "id": "38",
    "number": "38",
    "section": "Tanmātras & Subtle Body",
    ...
    "keyPoints": [
      "Tanmātras (undifferentiated) give rise to the five gross elements (differentiated).",
      "The same object can produce tranquillity in one observer, terror in another, and confusion in a third — the feeling is not a property of the object itself."
    ]
  },
  {
    "id": "39",
    ...
    "keyPoints": [
      "Three kinds of body: the persisting subtle body, the perishable parent-born body, and the gross-elemental body.",
      "Sāṃkhya's account of the subtle body differs from the Vedāntic account — a genuine point of disagreement between the two systems."
    ]
  },
  {
    "id": "40",
    "number": "40",
    "section": "Tanmātras & Subtle Body",
    "devanagari": "पूर्वोत्पन्नमसक्तं नियतं महदादिसूक्ष्मपर्यन्तम् ।\nसंसरति निरुपभोगं भावैरधिवासितं लिङ्गम् ॥ ४० ॥",
    "iast": "pūrvotpannam, asaktam, niyatam, mahdādi-sūkṣma-paryantam |\nsaṃsarati nirupabhogaṃ bhāvair-adhivāsitaṃ liṅgam |",
    "diagramId": "linga-sharira",
    "conceptIds": [
      "linga-sharira"
    ],
    "translation": "The Liṅga — first-formed, unattached to any particular body, permanent, extending from Mahat down to the subtlest things, incapable of enjoyment on its own, and imbued with dispositions — migrates.",
    "commentary": "The Liṅga, being pure potential energy, cannot itself enjoy or even manifest until it acts upon a grosser substance; this is why it is never found apart from some subtle body. Sāṃkhya's separate conception of the Liṅga becomes necessary precisely to explain how a subtle body can change type entirely — from human to animal or back — across a rebirth, something a fixed subtle body could not do on its own.",
    "keyPoints": [
      "The Liṅga is imbued with dispositions (bhāvas) but has no capacity to enjoy anything by itself.",
      "A separate Liṅga (distinct from any one subtle body) is needed to explain how rebirth can cross entirely different types of body."
    ]
  },
  {
    "id": "41",
    "number": "41",
    "section": "Tanmātras & Subtle Body",
    "devanagari": "चित्रं यथाश्रयमृते स्थाण्वादिभ्यो विना यथा च्छाया ।\nतद्वद्विना विशेषैर्न तिष्ठति निराश्रयं लिङ्गम् ॥ ४१ ॥",
    "iast": "citraṃ yathā-'śrayam-ṛte, sthāṇvādibhyo-vinā yathā-cchāyā |\ntadvad vinā viśeṣair-na tiṣṭhati nirāśrayaṃ liṅgam |",
    "conceptIds": [
      "linga-sharira"
    ],
    "translation": "Just as a picture cannot exist without a canvas, or a shadow without something to fall on, so the Liṅga cannot manifest without a Viśeṣa (a subtle body), which it itself creates.",
    "commentary": "A clarifying analogy for the point just made in Kārikā 40 — the Liṅga is never found unsupported; it always creates the very subtle body it then depends upon.",
    "keyPoints": [
      "The Liṅga always creates its own support (a subtle body) and can never manifest without it — like a picture needing a canvas."
    ]
  },
  {
    "id": "42",
    "number": "42",
    "section": "Tanmātras & Subtle Body",
    "devanagari": "पुरुषार्थहेतुकमिदं निमित्तनैमित्तिकप्रसङ्गेन ।\nप्रकृतेर्विभुत्वयोगान्नटवद्व्यवतिष्ठते लिङ्गम् ॥ ४२ ॥",
    "iast": "puruṣārtha-hetukam-idaṃ nimitta-naimittika-prasaṃgena |\nprakṛter-vibhutvayogān-naṭavad-vyavatiṣṭhate liṅgam |",
    "conceptIds": [
      "linga-sharira"
    ],
    "translation": "For the sake of Puruṣa, by the interplay of cause and effect, and by the power of Prakṛti, the Liṅga behaves — migrates — like an actor playing different parts.",
    "commentary": "Sāṃkhya's account of transmigration differs from a moral bookkeeping of reward and punishment: at death, the accumulated resultant of one's thoughts determines the next Liṅga, which creates a new subtle body of whichever of the fourteen types fits, and enters it, leaving the old one behind — the continuity of the Liṅga preserved through every change of costume, as an actor changes roles.",
    "keyPoints": [
      "Rebirth is driven by the resultant of accumulated thoughts at death, not by a separate system of reward and punishment.",
      "The actor-changing-costumes image: the Liṅga's identity persists continuously while its outer form (subtle body) changes across lives.",
      "Rebirth serves Puruṣa's eventual self-realization — it is described as part of a natural evolutionary process, not a punishment."
    ]
  },
  {
    "id": "43",
    ...
    "keyPoints": [
      "The eight dispositions are partly innate (carried from past lives) and partly acquired in the present one.",
      "Dispositions are sustained by Buddhi; the embryo/body is sustained by its own material development — two different kinds of dependency running in parallel."
    ]
  },
  {
    "id": "44",
    ...
    "keyPoints": [
      "Four consequences: Dharma → upward rebirth, Adharma → downward rebirth, Jñāna → release, Ajñāna → bondage."
    ]
  },
  {
    "id": "45",
    ...
    "keyPoints": [
      "Vairāgya (dispassion) → merger back into Prakṛti; passionate attachment → continued transmigration.",
      "Aiśvarya (power) removes obstruction to one's desires; its absence produces the opposite.",
      "Together with Kārikā 44, this completes the eightfold scheme of Buddhi's dispositions from Kārikā 23."
    ]
  },
  {
    "id": "46",
    "number": "46",
    "section": "The Fifty Categories",
    "devanagari": "एष प्रत्ययसर्गो विपर्ययाशक्तितुष्टिसिद्ध्याख्यः ।\nगुणवैषम्यविमर्दात्, तस्य च भेदास्तु पञ्चाशत् ॥ ४६ ॥",
    ...
    "keyPoints": [
      "Four master categories of the Buddhi-created sense-world: Viparyaya, Aśakti, Tuṣṭi, Siddhi — fifty subdivisions altogether."
    ]
  },
  {
    "id": "47",
    "number": "47",
    "section": "The Fifty Categories",
    "devanagari": "पञ्चविपर्ययभेदा भवन्त्यशक्तिश्च करणवैकल्यात् ।\nअष्टाविंशतिभेदा तुष्टिर्नवधाऽष्टधा सिद्धिः ॥ ४७ ॥",
    "iast": "pañca viparyaya-bhedā bhavanty-aśaktiś-ca karaṇa-vaikalyāt |\naṣṭāviṃśati-bhedā tuṣṭir navadhā-ṣṭadhā siddhiḥ |",
    "conceptIds": [
      "pratyaya-sarga"
    ],
    "translation": "False knowledge is of five kinds; incapacity, arising from defects in the organs, is of twenty-eight kinds; complacency of the mind is of nine kinds; true knowledge has eight divisions.",
    "commentary": "The tally is given here; the individual varieties are explained in the kārikās that follow, beginning with the five kinds of Viparyaya.",
    "keyPoints": [
      "The count: 5 Viparyaya + 28 Aśakti + 9 Tuṣṭi + 8 Siddhi = 50 total categories."
    ]
  },
  {
    "id": "48",
    ...
    "keyPoints": [
      "Tamas (8), Moha (8), Mahāmoha (10), Tāmisra (18), Andhatāmisra (18) — the five varieties of false knowledge, sixty-two sub-varieties in total.",
      "These five correspond to the five kleśas of Patañjali's Yoga: Avidyā, Asmitā, Rāga, Dveṣa, Abhiniveśa."
    ]
  },
  {
    "id": "49",
    ...
    "keyPoints": [
      "Twenty-eight incapacities = eleven organ-infirmities + seventeen Buddhi-infirmities.",
      "Even organic defects like blindness or deafness are ultimately traced back to Buddhi, the creator of the sense-world."
    ]
  },
  {
    "id": "50",
    ...
    "keyPoints": [
      "Four internal complacencies: resting on Nature, on means, on time, or on luck to bring release without further effort.",
      "Five external complacencies: mistaking abstinence from sense-pleasures for genuine progress toward liberation.",
      "Tuṣṭi in general is described as a form of indolence that halts the search for discriminative knowledge."
    ]
  },
  {
    "id": "51",
    "number": "51",
    "section": "Eight Paths to True Knowledge",
    ...
    "keyPoints": [
      "Eight positive paths to knowledge: reasoning, oral instruction, study, the three remedies for the three-fold affliction, friendship, and charity.",
      "This directly answers Kārikā 1: it names the actual means by which the three-fold affliction can be ended."
    ]
  },
  {
    "id": "52",
    ...
    "keyPoints": [
      "The physical world (Liṅgākhya Sarga) and the sense/psychical world (Bhāvākhya Sarga) are mutually dependent, like two poles of a single magnet.",
      "Thought and physical energy are treated as convertible into one another — a continuous exchange, not two separate domains."
    ]
  },
  {
    "id": "53",
    "number": "53",
    "section": "The Fourteen Realms",
    "devanagari": "अष्टविकल्पो दैवस्तैर्यग्योनश्च पञ्चधा भवति ।\nमानुषकश्चैकविधः, समासतो भौतिकः सर्गः ॥ ५३ ॥",
    "iast": "aṣṭa-vikalpo-daivas-tairyagyonaś-ca pañcadhā bhavati |\nmānuṣakaś-caikavidhaḥ, samāsato-bhautikaḥ sargaḥ |",
    "conceptIds": [
      "three-worlds"
    ],
    "translation": "The celestial creation is of eight kinds, the sub-human creation of five kinds, and the human creation of one kind; such, in brief, is the physical creation of the elements.",
    "commentary": "The eight celestial orders (Brāhma, Prājāpatya, Aindra, Paitra, Gāndharva, Yākṣa, Rākṣasa, Paiśāca), the five sub-human orders (cattle, wild animals, birds, reptiles, and immovable life such as plants and minerals), and the single human order together make fourteen types of embodiment, each with its own subtle body, through which the Liṅga can migrate.",
    "keyPoints": [
      "Fourteen total orders of creation: eight celestial, five sub-human, one human.",
      "The object of this whole scheme is the gradual evolution of the Liṅga from matter toward spirit, across successive rebirths."
    ]
  },
  {
    "id": "54",
    "number": "54",
    "section": "The Fourteen Realms",
    "devanagari": "ऊर्ध्वं सत्त्वविशालस्तमोविशालश्च मूलतः सर्गः ।\nमध्ये रजोविशालो, ब्रह्मादिस्तम्बपर्यन्तः ॥ ५४ ॥",
    "iast": "ūrdhvaṃ sattva-viśālaḥ, tamo-viśālaś-ca mūlataḥ sargaḥ |\nmadhye rajo viśālo, brahmādi-stamba-paryantaḥ |",
    "diagramId": "three-worlds",
    "conceptIds": [
      "three-worlds",
      "three-gunas"
    ],
    "translation": "High up, Sattva predominates; at the bottom, Tamas; in the middle, Rajas — this holds true from Brahmā down to a blade of grass.",
    "commentary": "The fourteen realms of Kārikā 53 are further divided by which Guṇa dominates the temperament of their inhabitants — a vertical map of the whole creation running from the celestial orders, through humanity, down to plant and mineral life.",
    "keyPoints": [
      "The fourteen orders of creation map onto the three Guṇas: Sattva dominant above, Tamas below, Rajas in the middle."
    ]
  },
  {
    "id": "55",
    "number": "55",
    "section": "Toward Liberation",
    ...
    "keyPoints": [
      "Old age and death are inevitable for as long as the Liṅga (the vehicle of rebirth) continues to function.",
      "Liberation requires the Liṅga's dissolution — Puruṣa parting definitively from Prakṛti, not merely a change of realm."
    ]
  },
  {
    "id": "56",
    ...
    "keyPoints": [
      "Prakṛti's activity looks self-interested but is, according to the text, entirely for the sake of Puruṣa's release."
    ]
  },
  {
    "id": "57",
    ...
    "keyPoints": [
      "The cow's-milk analogy: an unintelligent process (milk secretion, or Prakṛti's activity) can still serve a real purpose (a calf's nourishment, or Puruṣa's release) without conscious design.",
      "Phukan candidly notes that why creation occurs at all — rather than the Avyakta remaining eternally unmanifest — is left unanswered by both Sāṃkhya and Vedānta."
    ]
  },
  {
    "id": "58",
    ...
    "keyPoints": [
      "A second image for purposeful-without-design activity: engaging in play to satisfy curiosity, as the Avyakta 'engages' for Puruṣa's sake."
    ]
  },
  {
    "id": "59",
    ...
    "keyPoints": [
      "The dancing-girl analogy: Prakṛti performs for the 'whole audience' of a soul's whole experience, not stopping at the first sign of understanding.",
      "Phukan raises and prefers an alternative solution: Puruṣas and Prakṛtis may both be plural, each soul effectively having its own Prakṛti — comparable to no two observers seeing quite the same world."
    ]
  },
  {
    "id": "60",
    ...
    "keyPoints": [
      "Prakṛti acts entirely without benefit to herself, purely for Puruṣa's sake — an asymmetric relationship.",
      "The puzzle this verse sets up: if Prakṛti is real, how can she disappear from a liberated Puruṣa's all-seeing awareness? The next five kārikās answer this."
    ]
  },
  {
    "id": "61",
    ...
    "keyPoints": [
      "The decisive realization: Prakṛti is only the phenomenal cause, not the ultimate reality — grasping this is itself what ends her display to that Puruṣa.",
      "This directly resolves the difficulty raised at the end of Kārikā 60."
    ]
  },
  {
    "id": "62",
    ...
    "keyPoints": [
      "Strictly speaking, bondage, transmigration, and release are events that happen only to Prakṛti, never to the changeless Puruṣa himself.",
      "Sāṃkhya notes this position is shared broadly across Indian philosophy — Buddhism, the Upaniṣads, and the Gītā all agree that only the Saṃskāra/Liṅga migrates."
    ]
  },
  {
    "id": "63",
    ...
    "keyPoints": [
      "Seven of Buddhi's eight dispositions (Kārikā 23) bind; only the eighth, Jñāna, releases.",
      "Puruṣa cannot remove this 'screen' himself, being wholly inactive — its removal is Prakṛti's own doing, through Jñāna."
    ]
  },
  {
    "id": "64",
    ...
    "keyPoints": [
      "The liberating realization takes the form of a threefold negation: 'I am not (this), nothing is mine, I do not exist (as this).'",
      "This is called intimate knowledge (not symbolic or theoretical) — consciousness recognizing itself as distinct from everything Buddhi presents to it."
    ]
  },
  {
    "id": "65",
    ...
    "keyPoints": [
      "Thoughts, unlike physical objects, exist as living thoughts only when actively witnessed — never independently.",
      "Once Puruṣa withdraws his witnessing entirely, Prakṛti's forms become unobservable — she has no separate existence apart from having been seen."
    ]
  },
  {
    "id": "66",
    ...
    "keyPoints": [
      "Even where a residual connection between Puruṣa and Prakṛti continues, no further rebirth follows once the Liṅga is emptied of every disposition but the bare ego-sense.",
      "Sāṃkhya compares this to a fried seed: still recognizably a seed, but incapable of germinating."
    ]
  },
  {
    "id": "67",
    ...
    "keyPoints": [
      "Liberation-in-knowledge (jīvanmukti) does not end embodied life immediately — the potter's-wheel image explains why life continues by momentum after the 'push' has stopped."
    ]
  },
  {
    "id": "68",
    ...
    "keyPoints": [
      "Kaivalya here is described as 'both certain and final' — aikāntika (unfailing) and ātyantika (never to be reversed)."
    ]
  },
  {
    "id": "69",
    ...
    "keyPoints": [
      "The text signals its own transition here from philosophical argument to a closing account of its transmission and authorship."
    ]
  },
  {
    "id": "70",
    ...
    "keyPoints": [
      "The teaching lineage named explicitly: Kapila → Āsuri → Pañcaśikha, who elaborated it widely before Īśvarakṛṣṇa's condensation."
    ]
  },
  {
    "id": "71",
    ...
    "keyPoints": [
      "Īśvarakṛṣṇa names himself directly and frames the Kārikā as a condensed transmission of received teaching, not a new invention."
    ]
  },
  {
    "id": "72",
    ...
    "keyPoints": [
      "The Kārikā 150aims to condense the entire (lost) Ṣaṣṭitantra — 'the system of sixty topics' — without using illustrative stories or arguing against rival schools.",
      "Vācaspati's ten listed principal topics plus the fifty categories of Kārikās 46–L reportedly account for all sixty topics of that older system."
    ]
  },
  {
    "id": "73",
    ...
    "keyPoints": [
      "Textual note: this verse appears only in the Māthura commentary tradition, and along with Kārikā 72 may be a later addition — Gauḍapāda's own commentary appears to end at Kārikā 69 and calls the text 'seventy kārikās.'"
    ]
  }
];
