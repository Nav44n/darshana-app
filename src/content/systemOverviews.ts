...
export const systemOverviews: Record<string, SystemOverviewData> = {
  ...
  tantra: {
    ...
    summary: {
      en: "Tantra is the woven scripture that saves by expanding: revelation (Āgama) for an age too thin for the outer sacrifice, teaching that enjoyment itself becomes liberation because the world is Śakti's own body. This system unites six book-extracted root texts on one path — the Devī Māhātmya (the goddess and the inner war, via Sādhana-Samara), Kuṇḍalinī Tantra (the serpent power and its ascent, closed by the Trika foundations-and-practice bridge), the Lalitā Sahasranāma (Śrīvidyā's complete icon), the Śiva-sūtras (recognition aphorisms), the Spanda-kārikās (dynamic pulsation) and the Tantrāloka (Abhinavagupta's recognition metaphysics, closed by the Trika synthesis after Kamalakar Mishra's Kashmir Shaivism: abhasavada, evil and karma, recognition, the seven knowers) — each lightly touched and paraphrased into this app's own summaries.",
