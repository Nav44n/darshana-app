// Uttama Carita: Adhyaya 7 (Caṇḍa-Muṇḍa-Vadha)
// Part of the Devi Mahatmya EN verses (Adhyaya 7 of 13).
...
export const deviMahatmyaCh07En: RawVerseEn[] = [
{
    id: 'dm-7-1',
    number: '7.1-7',
...
अतिविस्तारवदना निमग्नारक्तनयना ।
जिह्वाललनभीषणा नादापूरितदिङ्मुखा ॥७॥`,
    iast: `ṛṣiruvāca |
...
ākṛṣṭacāpāsidharāstathānye tatsamīpagāḥ ||3||
...
vicitrakhaṭvāṅgadharā naramālā vibhūṣaṇā |
dvīpicarmaparīdhānā śuṣkamāṃsātibhairavā ||6||
ativistāravadanā nimagnāraktanayanā |
jihvālalanabhīṣaṇā nādāpūritadiṅmukhā ||7||`,
    conceptIds: ["kali-chamunda","cit-shakti","sadhana-samara"],
    translation: `The Ṛṣi said: So commanded, the demons led by Caṇḍa-Muṇḍa marched with fourfold armies, weapons raised. Then they beheld Devī seated at ease, faintly smiling, upon the lion on the great golden Himavat-peak. Seeing Her, the ready ones strove to seize Her — bows drawn, swords in hand, others closing in. Then Ambikā grew loudly wrathful at those foes, and with rage Her face turned ink-black. From Her brow-plank, crooked with the frown, swiftly issued Kālī — dread-faced, sword-and-noose in hand; bearing a wondrous skull-staff, garlanded with men’s heads, clad in tiger-skin, most dread with shrunken flesh; vast-mouthed, sunken red-eyed, dread with lolling tongue, Her visage filling the quarters with roar.`,
    commentary: `**Sādhana-Samara Commentary (wrath’s bottleneck births the Dark One):**
1. **Īṣaddhāsā**: they see Her “faintly smiling, at ease” on the golden peak — Śāntanavī notes the calculated smile (sotprāsa hāsa): She already knows Dhūmralocana’s fate will repeat. Demons read ease as weakness and reach to seize (samādātum) — the grasping reflex before every fall. Bows drawn, swords out: aggression approaching rest.
2. **Ink-black face**: kopena… maṣīvarṇam — rage as the ink of the void; the fair Mother (Gaurī) blackens toward Kālī. Emotion, intensified to bottleneck (bhrukuṭī-kuṭila-lalāṭa, the furrowed brow-plank), concentrates into a Person: Kālī issues FROM the frown — fury focused becomes the Dark Mother. For beginners: concentrated intensity, not suppressed anger, is Her birthplace.
  ...
  },
{
    ...
    number: '7.8-18',
    section: 'Uttama Carita (Rudra-Granthi Bheda / Śumbha-Niśumbha Vadha)',
    devanagari: `सा वेगेनाभिपतिता घातयन्ती महासुरान् ।
सैन्ये तत्र सुरारीणामभक्षयत तद्वलम् ॥८॥
पाणिग्राहाङ्कुशग्राही योधघण्टासमन्वितान् ।
...
बलिनां तद्वलं सर्वमसुराणां महात्मनाम् ।
...
क्षणेन तद्वलं सर्वमसुराणां निपातितम् ।
...
काली करालवक्त्रान्तर्दुर्दर्शदशनोज्ज्वला ॥१८॥`,
    iast: `sā vegenābhipatitā ghātayantī mahāsurān |
sainye tatra surārīṇāmabhakṣayata tadvalam ||8||
pāṇigrāhāṅkuśagrāhī yodhaghaṇṭāsamanvitān |
samādāyaikahastena mukhe cikṣepa vāraṇān ||9||
tathaiva yodhaṃ turagai rathaṃ sārathinā saha |
nikṣipya vaktre daśanaiścarvayantyatibhairavam ||10||
ekaṃ jagrāha keśeṣu grīvāyāmatha cāparam |
pādenākramya caivānyamurasānyamapothayat ||11||
tairmuktāni ca śastrāṇi mahāstrāṇi tathāsuraiḥ |
mukhena jagrāha ruṣā daśanairmathitānyapi ||12||
balināṃ tadvalaṃ sarvamasurāṇāṃ mahātmanām |
...
kṣaṇena tadvalaṃ sarvamasurāṇāṃ nipātitam |
dṛṣṭvā caṇḍo'bhidudrāva tāṃ kālīmatibhīṣaṇām ||15||
...
babhuryathārkabimbāni subahūni ghanodaram ||17||
tato jahāsātiruṣā bhīmaṃ bhairavanādinī |
kālī karālavaktrāntardurdarśadaśanojjvalā ||18||`,
    conceptIds: ["kali-chamunda","sadhana-samara"],
    translation: `She fell upon them swiftly, slaying great demons, and devoured that army amid the foe’s host. Seizing drivers, hook-men and warriors with bells, She flung elephants into Her mouth with a single hand. Likewise warriors with horses, chariot with driver — casting them into Her maw, She chewed them with teeth most dreadfully. One She seized by the hair, another by the neck, treading a third underfoot, crushing a fourth on Her breast. Weapons and great missiles loosed by the demons She caught in Her mouth in wrath, grinding them with Her teeth. That whole army of the strong, great-bodied demons She crushed, devoured some, smote others. Some slain by the sword, some felled by skull-staff blows, demons perished, others struck by tusk-tips. In a moment the demons’ whole army lay fallen. Seeing it, Caṇḍa charged the most dread Kālī. With dread arrow-rains the great demon veiled dread-eyed Her, and Muṇḍa with thousands of hurled discs. Those many discs entering Her mouth shone like many sun-orbs in a cloud’s belly. Then laughed Kālī, roaring dreadfully in exceeding wrath — teeth gleaming unbearably within Her dread mouth.`,
    commentary: `**Sādhana-Samara Commentary (the Void devours methodically):**
1. **Eating as method**: elephants with drivers, warriors with horses, chariots with drivers — whole formations (vehicle + driver + weapon = habit + agent + tool) go into the maw together; teeth grind weapons (mathitāni — churned). Śāntanavī: śastra-astra differ only in use-mode, not in being weapons — Kālī, the Void-awareness, devours every mode. For beginners: offer whole complexes to witness-awareness, not single thoughts — drivers too.
2. **Discs like suns in a cloud**: the simile inverts scale — Muṇḍa’s thousand discs, meant to veil Her, become ornaments in Her mouth, shining like sun-orbs in a cloud-belly. Attacks on the infinite decorate it. Nāgojī: “devīśaktir vicitrā” (the Goddess-power is astonishing) — by Her logic, opposition feeds Her.
  ...
  },
{
    ...
    number: '7.19-25',
    section: 'Uttama Carita (Rudra-Granthi Bheda / Śumbha-Niśumbha Vadha)',
    devanagari: `उत्थाय च महासिंहं देवी चण्डमधावत ।
...
yuddhayajñe svayaṃ śumbhaṃ niśumbhaṃ ca haniṣyasi ||23||
ṛṣiruvāca |
tāvānītau tato dṛṣṭvā caṇḍamuṇḍau mahāsurau |
uvāca kālī kalyāṇī lalitaṃ caṇḍikā vacaḥ ||24||
yasmāccaṇḍaṃ ca muṇḍaṃ ca gṛhītvā tvamupāgatā |
cāmuṇḍeti tato loke khyātā devī bhaviṣyasi ||25||`,
    conceptIds: ["kali-chamunda","shumbha-nishumbha","sadhana-samara"],
    translation: `Mounting the great lion, Devī rushed at Caṇḍa; seizing him by the hair, She cut his head with that sword. The demon-lord, head severed, gave a dread roar that shook the triple world. Then the remnant army, seeing Caṇḍa fallen and mighty Muṇḍa fleeing frightened to the quarters — Kālī, holding Caṇḍa’s head and Muṇḍa’s, approached Caṇḍikā with wild laughter and said: “By me are offered to Thee here Caṇḍa-Muṇḍa, two great beasts; in the battle-sacrifice Thyself shalt slay Śumbha-Niśumbha.” The Ṛṣi said: Then seeing Caṇḍa-Muṇḍa brought, gracious Kālī spoke sweetly to Caṇḍikā: “Since thou hast come holding Caṇḍa and Muṇḍa, thou shalt be famed in the world as CĀMUṆḌĀ.”`,
    commentary: `**Sādhana-Samara Commentary (two heads offered; a Name earned):**
1. **Hair-seized beheading**: Devī Herself (not Kālī) takes Caṇḍa — seizing by the hair (keśeṣu, the pride-crest) before the sword. Muṇḍa flees “to the quarters” (diśo bheje — scattered attention dissolving outward); his head too is taken (v22). Passion seized, gloom gathered — both laid at Caṇḍikā’s feet. For beginners: name the two heads in yourself (flare-up and sulk) and offer both; half-surrender keeps one alive.
2. **Yuddha-yajña**: Kālī calls battle a SACRIFICE and the demons mahā-paśū (great beasts for offering) — Guptavatī hears the metaphor’s force; Śāntanavī reads yuddhayajñe also as vocative (“O battle-sacrificer Devī”). Either way: sādhanā is ritual, foes are oblations, and Kālī is the priestess presenting Caṇḍa-Muṇḍa as pūrṇāhuti. The remaining oblations — Śumbha-Niśumbha — “Thyself shalt slay.”
