// Purvanga: Devi Kavaca (verses 1-51, "sardha-pancashat" recension)
...
//
// NOTE ON RECENSION: this file follows the numbering of the specific printed edition
// used as source (Guptavati-adi-sapta-tika-samvalita), whose colophon states the Kavaca
// comprises "sardha-pancashat" (50 and a half) verses - i.e. verses 1-51, the 51st being
// a half-verse. This differs from other common numbering schemes (e.g. some print the
// Saptamatr-dhyana as a separately-counted insertion reaching "56"). Both schemes describe
// the same underlying text; this file simply follows this edition's own count throughout.
import type { RawVerseEn } from './devi-mahatmya-verses-en';

export const deviMahatmyaVersesEnKavaca: RawVerseEn[] = [
{
    id: 'dm-kavacha-1',
    number: 'Kavaca 1',
    ...
    translation: `Markandeya said: “O Grandfather, tell me that which is the supreme secret in this world, the bringer of every protection to human beings, which you have never disclosed to anyone.”`,
...
Commentators read this opening as continuing the frame-dialogue of the larger text (Brahma to Markandeya, who in turn transmits it onward), and note the emphasis on 'guhya' (secret): unlike ordinary protective charms already current in the world, this one is being handed down for the first time as a guarded treasure - which the tradition reads as itself a reason for its reliability.`,
    keyPoints: ["**A treasure asked for, not owed**: The request is framed as asking for something never before shared, not claiming an entitlement.", "**'Every protection' stated upfront**: The scope - covering every part of a person, not one danger - is announced before a word of the armor itself is given."]
  },
{
    id: 'dm-kavacha-2',
    number: 'Kavaca 2',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `Brahma replied: “There exists, O Brahmin, a most secret thing beneficial to all beings - the sacred Armor (Kavaca) of the Goddess. Hear it, O great sage.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators treat this verse mainly as the formal hinge from dialogue-frame into the substance of the teaching, noting the vocative shift ('mahamune') as marking Markandeya's elevation, within this exchange, to the status of one fit to receive esoteric material.`,
    keyPoints: ["**Universal beneficiary, one immediate hearer**: The armor is said to help all beings even though it is being spoken to one person."]
  },
{
    id: 'dm-kavacha-3',
    number: 'Kavaca 3',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“First, Shailaputri; second, Brahmacharini; third, Chandraghanta; and Kushmanda the fourth.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators derive each name: Shailaputri as the mountain-king's daughter accepting a humble birth out of compassion for her devotee; Brahmachiarini as she whose conduct leads the seeker toward brahman; Chandraghanta as she whose bell rings with moon-like radiance; Kushmanda as the one who 'devours' (in the sense of consuming or absorbing) the threefold heat of worldly suffering, an etymology built from kubjha/ushma/anda.`,
    keyPoints: ["**Names before functions**: The nine forms are introduced before any protective assignment, so recognition precedes protection.", "**Etymology as teaching, not decoration**: Each name is traditionally read as encoding what that form of the Goddess actually does for the devotee."]
  },
{
    id: 'dm-kavacha-4',
    number: 'Kavaca 4',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Fifth, Skandamata; sixth, Katyayani; seventh, Kalaratri; and Mahagauri the eighth.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators gloss Skandamata as she in whose womb even realised sages long to be born (mother of Skanda); Katyayani as the form that appeared in the hermitage of sage Katyayana; Kalaratri as 'the night of even Time (Kala)', since she survives the dissolution that destroys Time itself; Mahagauri as the intensely fair one, her golden hue won through the austerity that transformed the dark Kali into radiant Gauri.`,
    keyPoints: ["**Nine forms, one continuous list**: No commentary interrupts the naming - the recitation of names is presented as the practice, not preparation for it."]
  },
{
    id: 'dm-kavacha-5',
    number: 'Kavaca 5',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Ninth, Siddhidatri - thus are the Nine Durgas proclaimed. These very names have been spoken by the great soul Brahma himself.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note this verse settles a possible objection - that these nine names might be a sectarian innovation - by anchoring their authority in Brahma's own utterance, and observe that the singular 'kavacham' in the text's own self-description coheres with treating all nine as manifestations of a single Goddess rather than nine separate deities.`,
    keyPoints: ["**Authority stated explicitly**: The nine names are presented as Brahma's own speech, not a later devotee's invention."]
  },
{
    id: 'dm-kavacha-6',
    number: 'Kavaca 6',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“One burning in fire, one gone amid enemies in battle, one terrified in a dangerous or impassable place who takes refuge [in her] -”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators read this half-sentence (completed in the next verse) as establishing the register of what follows: not incremental improvement but rescue from situations where ordinary human effort has already failed.`,
    keyPoints: ["**Extremity, not inconvenience**: The examples chosen - fire, battlefield, wilderness - are worst-case scenarios, setting the scale of what the armor claims to address."]
  },
{
    id: 'dm-kavacha-7',
    number: 'Kavaca 7',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“- no misfortune whatsoever befalls them in the crisis of battle; I see no calamity, grief, sorrow or fear for them.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note the shift to first-person witness ('na apadam tasya pashyami') as strengthening the assurance rhetorically, though they're careful to specify (as the next verse makes explicit) that this fruit is tied to genuine devotion, not mere mechanical recitation.`,
    keyPoints: ["**Testimony, not just promise**: The claim is voiced as something witnessed within the narrative, adding rhetorical weight to the assurance."]
  },
{
    id: 'dm-kavacha-8',
    number: 'Kavaca 8',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“But by whomever these are remembered with devotion, prosperity surely arises for them. Chamunda is seated on a corpse; Varahi is seated on a buffalo.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators distinguish two kinds of devotion addressed across these verses - the distressed devotee's plea (verses 6-7) and the inquiring devotee's aspiration (from verse 8) - and note a recorded variant reading where 'siddhih' (spiritual attainment) appears in place of 'riddhih' (worldly prosperity), read by some as pointing to an inner as well as outer fruit.`,
    keyPoints: ["**Two kinds of devotee addressed**: The armor speaks first to someone in crisis, then to someone simply seeking to grow."]
  },
{
    id: 'dm-kavacha-9',
    number: 'Kavaca 9',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Aindri is mounted on an elephant; Vaishnavi on Garuda; Maheshvari mounted on a bull; Kaumari with a peacock as her mount.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators generally treat the Seven/Eight Mothers (Saptamatrikas/Ashtamatrikas) here as manifestations of the shaktis of the principal male deities, mobilised specifically for the protection of devotees - a standard Puranic doctrine the text is drawing on rather than innovating.`,
    keyPoints: ["**Power made active**: Each Mother's mount recalls a god's own vehicle, showing these forms as those gods' latent power turned into acting protection."]
  },
{
    id: 'dm-kavacha-10',
    number: 'Kavaca 10',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Brahmi mounted on a swan, adorned with every ornament, resplendent with manifold jewels and decorations.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators note that some manuscript traditions include an additional two verses at this point (naming Lakshmi, Ishvari and Narasimhi among further forms) which older commentators such as Nilakantha and Bhaskararaya did not accept as part of the Kavacha proper - an instance of textual variation the tradition itself flags rather than conceals.`,
    keyPoints: ["**A noted textual boundary**: Some manuscripts add further goddess-names here that respected older commentators explicitly excluded from the received text."]
  },
{
    id: 'dm-kavacha-11',
    number: 'Kavaca 11',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“The goddesses are seen mounted on chariots, filled with wrath, bearing conch, discus, mace, spear, plough and pestle-weapon.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators read the Mothers' anger (krodha-samakulah) as directed at what threatens the devotee, not as an arbitrary trait, consistent with the broader tradition's reading of divine wrath as protective rather than punitive when turned toward a devotee's true enemies.`,
    keyPoints: ["**Wrath as protection, not punishment**: The Mothers' fury is aimed outward, at what threatens the devotee - not at the devotee."]
  },
{
    id: 'dm-kavacha-12',
    number: 'Kavaca 12',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Shield, javelin, and axe, and noose as well; spear-weapon, trident, and the unsurpassed bow-weapon Sharnga.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators simply catalogue these as the standard iconographic weapons of the Mothers as a group, without dwelling further, treating the list's completeness (rather than any single item) as the point being made.`,
    keyPoints: ["**A composite arsenal exceeding any one god's**: Naming Vishnu's own bow among the Mothers' shared weapons underlines their collective power."]
  },
{
    id: 'dm-kavacha-13',
    number: 'Kavaca 13',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“For the destruction of demons' bodies, and for the fearlessness of devotees, they bear these weapons thus - and for the welfare of the gods too.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators read this triad (destroying evil / protecting devotees / benefiting the gods) as the standard threefold justification given throughout the wider text for the Goddess's fierce forms taking up arms at all.`,
    keyPoints: ["**Three beneficiaries, one action**: The same armed vigilance is said to serve devotees, gods and cosmic order together, not one at the expense of the others."]
  },
{
    id: 'dm-kavacha-14',
    number: 'Kavaca 14',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“O greatly strong, greatly zealous one, destroyer of great fear - save me, O Goddess hard to behold, increaser of enemies' fear!”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Some commentators explicitly instruct that this verse functions as an opening invocation to be recited before beginning the Kavacha's main body, rather than as part of the descriptive sequence proper - a sequencing note about how the text is meant to be used in practice, not just read.`,
    keyPoints: ["**From description to prayer**: This verse marks the shift from describing the Goddess's forms to directly addressing her.", "**A noted use in practice**: Some teachers prescribe reciting this verse first, as an invocation, before the armor itself begins."]
  },
{
    id: 'dm-kavacha-15',
    number: 'Kavaca 15',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“In the east may Aindri protect me; in the south-east, the fire-deity; in the south may Varahi protect; in the south-west, the sword-bearing one.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators work out the underlying logic that each directional guardian corresponds to the standard Puranic scheme of the ten guardians of the directions (dashadikpalas), with each deity's own shakti standing in for the deity: Indra's shakti in the east, Agni's in the south-east, Yama's (via Varahi) in the south, and so on.`,
    keyPoints: ["**The armor's structure begins here**: Naming forms shifts to placing them - the practitioner is now being ritually surrounded, not just informed.", "**Borrowed cosmology, not invention**: Each direction's guardian matches the existing Puranic scheme of the ten directional deities."]
  },
{
    id: 'dm-kavacha-16',
    number: 'Kavaca 16',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“In the west may Varuni protect; in the north-west, the deer-riding one; in the north may Kaumari protect; in the north-east, the trident-bearer.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators identify the 'deer-riding one' with Vayu's shakti (the wind-god traditionally rides a deer or antelope in some iconography) and Kaumari here with Kubera's north rather than her usual association with Skanda, noting that one deity's shakti can validly guard more than one point without contradiction.`,
    keyPoints: ["**One guardian, multiple posts allowed**: The commentators explicitly note it's no contradiction for the same goddess-form to be assigned guard-duty at more than one point."]
  },
{
    id: 'dm-kavacha-17',
    number: 'Kavaca 17',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Above, may Brahmani protect me; below, likewise Vaishnavi. Thus in the ten directions may Chamunda, riding a corpse, protect.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators are explicit that naming the directions alone would be pointless without this final line making clear it is the practitioner, standing at the center, who is being surrounded and protected in all directions - the verse's real subject is the person at the middle of the circle, not the directions themselves.`,
    keyPoints: ["**The circle closes on the practitioner**: All ten directions matter only because they surround a person standing at the center - that is stated as the real point of the passage.", "**Many guardians, one Chamunda**: The ten separate directional forms are gathered back into a single all-encompassing protector in the same breath."]
  },
{
    id: 'dm-kavacha-18',
    number: 'Kavaca 18',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“May Jaya stand before me, Vijaya stand behind; Ajita on my left side, and Aparajita on my right.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note little beyond the grammar here, but the choice of names is traditionally read as significant in itself: simply having Victory in front and the Unconquerable at one's side is treated as meaningful protection quite apart from any further gloss.`,
    keyPoints: ["**A second, tighter ring**: After the wide compass-circle, four more guardians seal the immediate space right around the body.", "**Names as the protection itself**: Jaya, Vijaya, Ajita and Aparajita - Victory, Triumph, Unconquered, Unconquerable - are treated as protective simply by being invoked at each side."]
  },
{
    id: 'dm-kavacha-19',
    number: 'Kavaca 19',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“May Udyotini protect my hair-crown; Uma, seated on my head, [protect the head]; Maladhari on the forehead, and Yashasvini protect the eyebrows.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note a recurring grammatical shortcut used throughout this whole section: often only 'stationed at X' or only 'protect Y' is stated explicitly in a given line, with the other half left to be supplied by the reader from the parallel structure of surrounding verses - a stylistic economy the commentators take pains to spell out fully, half-verse by half-verse.`,
    keyPoints: ["**Third and finest scale begins**: After compass-directions and body-perimeter, the armor now proceeds limb by limb, feature by feature.", "**A deliberate shorthand**: Many lines state only half of 'goddess X, stationed at Y, protects Y' - the commentators note this is intentional economy, not omission."]
  },
{
    id: 'dm-kavacha-20',
    number: 'Kavaca 20',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Trinetra [protects] between the eyebrows; Yamaghanta the nose; Shankhini between the eyes; Dvaravasini the region of the ears.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators treat this simply as continuing the established pattern from the previous verse, supplying the elided verbs as needed and noting only the occasional textual variant (e.g., some manuscripts read 'protects' where others have it understood).`,
    keyPoints: ["**The pattern holds**: Each facial feature in turn gets its own guardian-name, following the shorthand established in the previous verse."]
  },
{
    id: 'dm-kavacha-21',
    number: 'Kavaca 21',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Kalika [protects] the two cheeks; Shankari the base of the ears; Sugandha the nose; and Charchika the upper lip.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators are attentive to exactly this point: the nose is guarded twice in this stretch of verses (once for its structure, once - via 'Sugandha', 'the fragrant one' - for its function of smell), and they treat this doubling as intentional rather than redundant, since each name corresponds to a distinct aspect of the same organ.`,
    keyPoints: ["**One organ, more than one guardian**: The nose appears twice in this section, once for its physical form and once for its function of smell - read as deliberate, not repetitive."]
  },
{
    id: 'dm-kavacha-22',
    number: 'Kavaca 22',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Amritakala [protects] the lower lip; Sarasvati the tongue; Kaumari protects the teeth; Chandika the middle of the throat.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators note the aptness of Sarasvati's placement at the tongue as following naturally from her established role as goddess of speech (vac) throughout the wider tradition, requiring no further justification.`,
    keyPoints: ["**Fitting placement**: Sarasvati is placed exactly where her traditional domain - speech - is physically located: the tongue."]
  },
{
    id: 'dm-kavacha-23',
    number: 'Kavaca 23',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Chitraghanta [protects] the uvula, and Mahamaya the palate; Kamakshi protects the chin, and Sarvamangala my speech [as a whole].”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators read the appearance of 'vacham me' (my speech) here as summarising and closing off the preceding cluster of speech-related organs (lip, tongue, teeth, throat, uvula, palate, chin) under one final, comprehensive guardian.`,
    keyPoints: ["**Parts, then the whole**: After several verses on individual speech-organs, this verse finally guards the faculty of speech itself as one unit."]
  },
{
    id: 'dm-kavacha-24',
    number: 'Kavaca 24',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Bhadrakali [protects] the neck; Dhanurdhari the spine; Nilagriva the outer throat; Nalakubari the windpipe.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators here mostly clarify technical anatomical terms - distinguishing 'bahih-kantha' (the outer throat) from 'nalika' (the windpipe specifically) - so that the reader understands exactly which structure each name is assigned to guard, rather than treating the verse as merely poetic.`,
    keyPoints: ["**Anatomical precision**: The commentators take care to specify exactly which throat-structure each name refers to, treating the list as anatomically exact rather than loosely poetic."]
  },
{
    id: 'dm-kavacha-25',
    number: 'Kavaca 25',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“The sword-bearer [protects] both shoulders; the thunderbolt-bearer, my two arms; Dandini protects the two hands, and Ambika the fingers.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators define the precise anatomical spans intended: 'bahu' (arm) is glossed as running from elbow to shoulder, and 'hasta' (hand) from shoulder to fingers in a broader sense, or more narrowly from wrist to fingers - a technical clarification rather than a substantive religious point.`,
    keyPoints: ["**Whole-limb coverage**: Shoulder to fingertip is covered across just two names in a single verse, moving quickly along the arm."]
  },
{
    id: 'dm-kavacha-26',
    number: 'Kavaca 26',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Shuleshvari protects the nails; Naleshvari protects the belly; Mahadevi protects the two breasts; Shokavinashini the mind.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note a grammatical subtlety here: 'manah' (mind) is glossed as referring to citta (the faculty of thought/feeling) in this specific context, distinguishing it from other, more technical uses of the same word elsewhere in the tradition's psychology.`,
    keyPoints: ["**First move beyond the body**: After many verses of pure anatomy, this is where the armor first names something non-physical - the mind - as a protected 'part'."]
  },
{
    id: 'dm-kavacha-27',
    number: 'Kavaca 27',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“The goddess Lalita [protects] the heart; Shuladharini the belly; Kamini protects the navel, and likewise Guhyeshvari the private parts.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators simply confirm the straightforward assignment of each named form to its respective organ here, without extended discussion, treating the passage as continuing the established pattern rather than introducing anything requiring separate justification.`,
    keyPoints: ["**The heart given a gentle name**: Among many fierce protector-names in this section, the heart specifically is guarded by Lalita, one of the Goddess's most tender, graceful forms."]
  },
{
    id: 'dm-kavacha-28',
    number: 'Kavaca 28',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Bhutanatha [protects] the genitals, and the buffalo-riding one the anus; Bhagavati protects the waist, and Vindhyavasini the two knees.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note this candour matter-of-factly, simply identifying each named form (e.g. the buffalo-riding one as a form linked to Mahishasuramardini iconography) without treating the anatomical frankness of the passage as needing special comment or apology.`,
    keyPoints: ["**No part excluded**: The armor names guardians for the body's most private regions with the same plainness used for the face or hands - nothing is treated as unworthy of protection."]
  },
{
    id: 'dm-kavacha-29',
    number: 'Kavaca 29',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Mahabala, as proclaimed [in scripture], [protects] the shins; Vinayaki the space between the knees; Narasimhi the two ankles, and Amitaujasi the instep.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators single out the word 'prokta' here as evidence that at least this one name among many is explicitly flagged as drawn from established scriptural usage (agama) rather than freshly coined for this text, implying (without stating outright) that the other names may be more original to this particular composition.`,
    keyPoints: ["**A flagged citation within the list**: One name in this verse is explicitly marked as coming from established scripture, a small clue about how the whole list of names may have been assembled."]
  },
{
    id: 'dm-kavacha-30',
    number: 'Kavaca 30',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Shridhari [protects] the toes, and the one dwelling beneath the sole [protects] the sole of the foot; the fierce fanged one [protects] the nails and teeth, and Urdhvakeshini the hair.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note this deliberately, addressing the apparent overlap (nails and teeth already assigned earlier) by pointing out that just as one goddess may guard more than one location without contradiction, two different goddesses assigned to the same location is equally unproblematic - the coverage is meant to be generous, even redundant, not exhaustive-and-exclusive.`,
    keyPoints: ["**Deliberate overlap, not error**: Nails and teeth reappear here despite being covered earlier - the commentators explicitly say double coverage is not a contradiction."]
  },
{
    id: 'dm-kavacha-31',
    number: 'Kavaca 31',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Kauberi [protects] the pores of the skin, and Vagishvari the skin itself; Parvati protects the blood, marrow, fat, flesh, bone and adipose tissue.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note the deliberate use of the standard Ayurvedic dhatu-list here, observing that by this point the armor has moved from the visible, ordinary body to its unseen physiological substrate, extending the same principle of comprehensive protection to what the practitioner cannot see or feel directly.`,
    keyPoints: ["**Beyond the visible body**: The armor now protects tissues the practitioner cannot see or feel - blood, marrow, fat, bone - using the traditional Ayurvedic scheme of bodily constituents."]
  },
{
    id: 'dm-kavacha-32',
    number: 'Kavaca 32',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Kalaratri [protects] the intestines, and Mukuteshvari the bile; Padmavati [protects] the lotus-vessel [of the heart/breath], and likewise Chudamani the phlegm.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators register real disagreement over 'padmakosha': some read it as the abode of breath/vital air, others - citing a Upanishadic image of the heart as a downward-facing lotus-bud - insist it must mean the heart specifically, and the text preserves this open disagreement rather than silently picking one reading.`,
    keyPoints: ["**An openly unresolved reading**: Commentators disagree on whether this verse's 'lotus-vessel' means the breath or the heart, and the tradition preserves that disagreement rather than settling it."]
  },
{
    id: 'dm-kavacha-33',
    number: 'Kavaca 33',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Jvalamukhi [protects] the fire/glow of the nails, and Abhedya every joint of the body; Brahmani protects my vital seed, and likewise Chatreshvari my shadow.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators clarify 'nakha-jvalam' as the inherent luster or heat specifically located in the nails (rather than a separate substance), and note 'chaya' (shadow) as being included here precisely because, in the wider tradition, a person's shadow is sometimes treated as vulnerable to hostile influence in its own right - hence its explicit inclusion.`,
    keyPoints: ["**Beyond the body altogether**: This verse extends the armor's coverage to items not usually considered body-parts at all, including one's own shadow - included specifically because tradition holds the shadow can itself be a point of vulnerability."]
  },
{
    id: 'dm-kavacha-34',
    number: 'Kavaca 34',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“O Dharmacharini, protect my ego-sense, mind and intellect for me; and likewise the five vital breaths - prana, apana, vyana, samana and udana.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators here address a possible objection - that 'mind' was already named as protected back in verse 26 (by Shokavinashini) - by explaining that the earlier reference used 'manah' in the general sense of citta (the whole thinking-feeling faculty), while this verse's 'manah' is being distinguished more precisely within the fourfold scheme of ego, mind, intellect and (implicitly) consciousness.`,
    keyPoints: ["**The innermost point reached**: From directions and skin down to ego, mind, intellect and the breath itself - the descent completes at the very seat of subjective experience.", "**A deliberate re-visit, explained**: The commentators note the mind is named a second time here, in a more technical sense than its earlier, more general mention."]
  },
{
    id: 'dm-kavacha-35',
    number: 'Kavaca 35',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“May Chakrini ever protect fame, glory, and prosperity; Indrani protect my lineage, and O Chandika, protect my livestock.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators treat this as a deliberate structural shift: the sadhaka, having been protected inwardly and physically, is now protected across the outward, social and economic dimensions of a householder's actual life - reputation, lineage, livelihood - which the tradition treats as no less legitimate a concern than bodily safety.`,
    keyPoints: ["**A pivot from body to life-circumstance**: After exhaustively covering the physical person, the armor now turns to a householder's reputation, lineage and livestock."]
  },
{
    id: 'dm-kavacha-36',
    number: 'Kavaca 36',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“May Mahalakshmi protect my sons; may Bhairavi protect my wife; may Kshemakari protect the road; may Vijaya, present everywhere, protect [me].”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note the appearance of variant readings at this point in different manuscript traditions - some placing an additional verse here naming the highway and royal court specifically - treated as manuscript variation rather than a substantive doctrinal difference.`,
    keyPoints: ["**A hint of the coming closure**: Vijaya is described here as 'stationed everywhere,' anticipating the text's own explicit acknowledgment, shortly after, that some place might otherwise be missed."]
  },
{
    id: 'dm-kavacha-37',
    number: 'Kavaca 37',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Whatever place is left without protection, left out by this armor - O Goddess, may Jayanti, destroyer of sin, protect all of that for me.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators read this verse as functioning precisely to remove any anxiety a meticulous reader might feel about incompleteness: whatever the detailed list overlooked is explicitly assigned to Jayanti, 'the ever-victorious,' whose sin-destroying nature is invoked as sufficient to cover any oversight without needing to identify what that oversight might be.`,
    keyPoints: ["**An honest acknowledgment of gaps**: Rather than claiming the list was perfectly complete, the text explicitly assigns whatever was missed to one final guardian."]
  },
{
    id: 'dm-kavacha-38',
    number: 'Kavaca 38',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“A person desiring their own welfare should not go even a single step without it. Ever enveloped by the armor, wherever such a person goes -”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators cite supporting verses from elsewhere in the Puranas making the same point in different words - that one should keep the Goddess in mind continuously, whether sleeping, walking, talking or eating - to reinforce that this is a general principle about constant remembrance, not a claim unique to this text alone.`,
    keyPoints: ["**A rule of constancy, not occasion**: The instruction is not to recite this once for protection, but to remain continuously 'wearing' it in awareness at every step."]
  },
{
    id: 'dm-kavacha-39',
    number: 'Kavaca 39',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“- there, gain of wealth and victory over all desires follow. Whatever object of desire one contemplates, that one certainly attains.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators, in their usual style for this kind of praise-verse (phala-shruti), generally accept these claims as stated while noting elsewhere in the tradition that such promises are understood to operate within the framework of one's own accumulated karma, rather than overriding it outright - a caveat more often implicit than stated directly in the verse itself.`,
    keyPoints: ["**An unconditional-sounding promise**: The verse states success as a certainty rather than a probability, in the conventional style of a scripture's closing praise-section."]
  },
{
    id: 'dm-kavacha-40',
    number: 'Kavaca 40',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“A man will attain unequalled supreme prosperity on this earth; a mortal becomes fearless, unconquered in battles.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators typically treat such sweeping promises as characteristic of the phala-shruti genre found throughout Puranic literature, whose function is understood partly as exhortation - encouraging sustained practice - rather than as a literal, mechanically guaranteed outcome divorced from the practitioner's devotion and conduct.`,
    keyPoints: ["**From wealth to fearlessness**: The promised fruits expand from material gain to an inner quality - courage and imperturbability in the face of conflict."]
  },
{
    id: 'dm-kavacha-41',
    number: 'Kavaca 41',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“A man enveloped by the armor becomes worthy of worship in all three worlds. This armor of the Goddess is rare to attain even for the gods themselves.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators read 'durlabham' (hard to attain) here less as a literal claim about divine access and more as standard scriptural hyperbole meant to impress upon a human audience just how valuable the teaching being received truly is - a common device across the Puranic phala-shruti genre.`,
    keyPoints: ["**Rarity as rhetorical emphasis**: The claim that even gods find this armor hard to obtain functions mainly to underscore its value to the human reciter, in a genre known for this kind of praise."]
  },
{
    id: 'dm-kavacha-42',
    number: 'Kavaca 42',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“One who recites this daily, self-controlled, at the three junctures [of the day], filled with faith - a portion of divinity arises in him; he becomes unconquered in the three worlds.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators treat 'daivi kala' (a portion of the divine) as indicating a genuine, if partial, participation in the Goddess's own nature accruing to the sincere daily reciter - not a metaphor, but understood literally within the text's own theology of divine grace transmitted through consistent practice.`,
    keyPoints: ["**Conditions finally stated**: After several verses of open-ended promise, this verse specifies exactly what earns the fruit - daily, disciplined, thrice-a-day recitation done with genuine faith."]
  },
{
    id: 'dm-kavacha-43',
    number: 'Kavaca 43',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“He lives more than a hundred years, free from untimely death. All diseases perish - skin-eruptions, boils and the like.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
Commentators note the specific diseases named (lūta/spider-related skin conditions, visphotaka/pustular eruptions) as representative examples rather than an exhaustive medical list, standing in for disease broadly rather than limiting the promise to skin ailments alone.`,
    keyPoints: ["**From abstraction to the concrete**: Named skin ailments serve as specific, tangible examples standing in for the broader promise of freedom from disease."]
  },
{
    id: 'dm-kavacha-44',
    number: 'Kavaca 44',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Whatever poison there may be - from plants, from moving creatures, or artificially compounded - and all sorcery, spells and ritual implements upon the earth [are destroyed] -”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators classify the three kinds of poison named - sthavara (from stationary sources like plants), jangama (from moving creatures such as snakes), and kritrima (artificially compounded) - as together exhausting all recognized categories of poison in the classical toxicological scheme, again showing the text's habit of using comprehensive, systematic categories rather than vague generalities.`,
    keyPoints: ["**A systematic threat-taxonomy**: Poison is divided into the three classical categories - plant, creature, and compounded - rather than named vaguely, continuing the text's pattern of exhaustive classification."]
  },
{
    id: 'dm-kavacha-45',
    number: 'Kavaca 45',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“- earth-roaming, sky-roaming, water-born and instruction-derived [hostile beings], and the innate, lineage-based, and garland/chain [forms of witchcraft], along with Dakini and Shakini spirits -”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators here mostly gloss the more obscure technical terms for classes of malevolent beings and sorcery-types current in the tantric literature of the period, without extended doctrinal comment, treating the passage as a specialist's list requiring definition rather than debate.`,
    keyPoints: ["**Every domain and every origin covered**: Hostile beings are catalogued by where they roam (earth, sky, water) and by how their power arose (innate, learned, inherited)."]
  },
{
    id: 'dm-kavacha-46',
    number: 'Kavaca 46',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“- terrifying sky-roaming Dakinis of great strength; planetary spirits, ghosts, pishachas, yakshas, gandharvas and rakshasas -”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators again mostly identify these as standard categories of semi-divine and malevolent beings found throughout Puranic literature (grahas, bhutas, pishachas, yakshas, gandharvas, rakshasas), noting no unusual doctrine attached to their inclusion here beyond simple comprehensiveness.`,
    keyPoints: ["**Standard cosmological categories, not invention**: The spirit-classes named here are drawn from the wider Puranic repertoire, not unique to this text."]
  },
{
    id: 'dm-kavacha-47',
    number: 'Kavaca 47',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“- brahma-rakshasas, vetalas, kushmandas, and bhairavas and the like - all these perish merely by the sight of one in whose heart this armor abides.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators emphasize the phrase 'kavace hridi samsthite' (the armor being seated in the heart) as the operative condition - it is not the external recitation alone but genuine internalisation of the armor that is said to produce this effect, distinguishing rote repetition from lived practice.`,
    keyPoints: ["**Presence over combat**: The extensive catalogue of threats is resolved not by fighting them but by the mere sight of someone in whom the armor has become internal.", "**Internalisation as the real condition**: The commentators stress that it is the armor being genuinely 'seated in the heart,' not simply spoken aloud, that produces this effect."]
  },
{
    id: 'dm-kavacha-48',
    number: 'Kavaca 48',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“Such a person's standing increases with kings; it is supreme in increasing one's inner radiance. Adorned with fame upon this earth, he too grows in glory.”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators note little beyond confirming the straightforward sense of the verse, treating it as a fairly conventional closing item in the catalogue of worldly benefits typical of this genre.`,
    keyPoints: ["**Standing with the powerful**: Among the closing worldly benefits, favor specifically with kings and rulers is named, alongside a more general increase in personal radiance."]
  },
{
    id: 'dm-kavacha-49',
    number: 'Kavaca 49',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“One should first perform the Kavacha and then recite the Chandi Saptashati. For as long as this earth bears its mountains, forests and groves -”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators treat this verse as settling, in the text's own words, the exact relationship between the Kavacha and the Saptashati proper: the armor is explicitly positioned as a preliminary (anga) to the main recitation, not an independent practice to be performed alone, resolving any ambiguity about how the whole should be sequenced.`,
    keyPoints: ["**The master-instruction, stated plainly**: After the entire text, the actual rule of practice is given directly - recite the armor first, then the Saptashati - settling how the two relate."]
  },
{
    id: 'dm-kavacha-50',
    number: 'Kavaca 50',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“- for that long does one's lineage of sons and grandsons endure upon the earth. At the end of the body, [one attains] the supreme abode, rare even for the gods -”`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators here draw on the wider Puranic and Upanishadic vocabulary of liberation (calling the 'supreme abode' effectively synonymous with the ultimate goal described elsewhere as moksha), reading this closing promise as pointing beyond worldly benefit entirely, toward final release.`,
    keyPoints: ["**From lineage to liberation**: The final promise moves from the endurance of one's family line to a state after death described as beyond what even the gods attain."]
  },
{
    id: 'dm-kavacha-51',
    number: 'Kavaca 51',
    ...
    iast: "",
    conceptIds: ["sadhana-samara", "cit-shakti"],
    translation: `“- which a person attains eternally, through the grace of Mahamaya.” Thus concludes the sacred Devi Kavacha.`,
    commentary: `**Sādhana-Samara Commentary:**
...
The commentators close by noting this text, in this particular recension, comprises fifty and a half verses in total (sardha-panchashat), and record that a further closing line found in some manuscripts ('he attains the supreme form and rejoices together with Shiva') was not accepted as part of the received text by the majority of authoritative commentators, being excluded here on that basis.`,
    keyPoints: ["**Grace, not achievement, as the final word**: The entire armor closes by attributing its ultimate fruit to divine grace rather than to the practitioner's own effort."]
  },
];
