...
// (footnote:  for it at Adhyaya 1, shlokas 53-67); Navarna-vidhi
...
// Sukta p.690 (footnote:  at Adhyaya 5, shlokas 7-36);
...
//   (condensed digests with opening verses summarised (mula not reproduced), pp.701-722),
...
**Seven-Commentary Digest:** this sukta carries no verse-by-verse Sanskrit tika in this edition (it is parayana frame, not adhyaya text); the Hindi Chandraprabha-style rendering treats Ratri as para-chicchakti — darkness that is not mere absence but the Mother's own all-pervading, karma-overseeing, ignorance-dispelling night-form, sister to Ushas (brahmavidya).`,
    keyPoints: ["**Ratri as cit-shakti**: Night is the Mother overseeing karma and dispelling ignorance, not mere darkness."]
  },
  {
    ...
    keyPoints: ["**Inner exorcism**: Wolf, she-wolf and thieves are vasanas and passions to be set apart, then crossed over (sutara = moksha-giving).", "**Dawn clears debt**: Knowledge removes ignorance the way wealth removes debt."]
  },
  {
    ...
    commentary: `**Why a cross-reference instead of re-transcription:** the edition itself flags the identity by footnote (p.66: "             "; p.690: "            "). Reprinting the same 40+ verses a second time would double-count mantra-units and break the mantra-vibhaga totals (700). The faithful A-Z move is to record WHERE each stands in parayana order while pointing at the single transcribed source (dm-1-* and dm-5-*).`,
    keyPoints: ["**No double-counting**: Tantrokta Suktas live once in ch01/ch05; here only their parayana seats are fixed.", "**Footnotes are the proof**: The edition itself sends the reader to Adhyaya 1.53-67 and 5.7-36 for arth."]
  },
  {
    ...
    commentary: `**Condensed digest (full Rahasya pp.701-709; opening 4 verses summarised here (mula not reproduced)):** Guptavati (p.702) reads "bhakto'si" as devotee of both Devi and guru, and frames Chandika as the fourth (turiya), dharmin-rupa, beyond the three vyashti forms (Mahakali/Mahalakshmi/Mahasarasvati) yet worshipped through one of them as chief. Verses 5-8 (pp.703-704) fix Her iconography: citron (matulunga), mace, shield, wine-cup in hand; serpent, linga and yoni on the crown (Brahma-Vishnu-Rudra, male-female in one); molten-gold hue; then, seeing the void, She takes a second form of pure tamas — dark collyrium, tusked, wide-eyed (Mahakali). The Hindi Chandraprabha follows the same two-form exposition verse by verse. Remainder (creation of Mahakali/Mahalakshmi/Mahasarasvati pairs, gunas, vahanas) is summary, not fresh translation, pending full transcription.
...
**Seven-Commentary Digest:** only Guptavati + Chandraprabha gloss the Rahasyas in this edition (the other five tikas stop at Adhyaya 13); both agree Mahalakshmi here is the samashti (triguna whole), not one vyashti among three — Guptavati argues it vialakshya/alakshya (saguna/nirguna) with Devi-Atharvashirsha shruti.`,
    keyPoints: ["**Samashti, not one of three**: Pradhanika Mahalakshmi is the triguna whole pervading all, perceptible-imperceptible.", "**Two forms, one Lady**: Golden Mahalakshmi beholds the void, then assumes the dark Mahakali form from pure tamas.", "**Shadanga 4/6**: First of the three Rahasyas, recited AFTER the 13 adhyayas (Katyayani-tantra proof quoted p.701)."]
  },
  {
    ...
    interpretiveNotes: [
      {
        note: `${PROVENANCE} Vaikritika Rahasya pp.710-717 (Rahasya-traya 2/3; shadanga 5/6). Opening 2 verses summarised (mula not reproduced); Guptavati notes quoted (trimshhallochana = 3 eyes per each of 10 faces; ayudhas from dakshina-adhah-kara order). Hindi Chandraprabha mirrors per verse.`
      }
    ],
    ...
    commentary: `**Condensed digest (pp.710-717; opening verses summarised (mula not reproduced)):** verses 3-6 fix Mahakali's vikriti (ten faces/feet/arms, collyrium-dark, thirty-eye garland, sword-arrow-mace-spear-conch-discus-bhushundi-parigha-bow plus bleeding severed head); Guptavati glosses "trimshat" as three eyes per face and orders weapons from the lower-right hand round. Verses 7-13 unfold Mahalakshmi's vikriti (born of all deva-bodies, Mahisha-mardini, white face/blue arms/red middle, eighteen — really thousand — arms with rosary-to-noose series, worship of whom makes one lord of worlds). Remainder (Mahasarasvati/Gauri vikriti, Shumbha-slaying form) is summary. Chandraprabha Hindi tracks each attribute plainly (pp.711-717).`,
    keyPoints: ["**Vikriti = functional form**: One samashti assumes distinct battle-bodies per guna-task; names multiply, Lady stays one.", "**Mahakali vikriti**: Ten-faced, thirty-eyed, ten-armed Yoganidra praised by Brahma against Madhu-Kaitabha.", "**Mahalakshmi vikriti**: Deva-body-born, eighteen/thousand-armed Mahisha-mardini; worshippers become world-lords."]
  },
  {
    id: 'dm-rahasya-murti',
    ...
    keyPoints: ["**Seven murtis, dated futures**: Nanda through Bhramari are the dated descents (avataras) whose prakriti Pradhanika already named.", "**Raktadantika vow**: Whoever studies her body-hymn daily is served by Her as a beloved wife serves — bhakti compulsion, not magic.", "**Shadanga closure**: With Murti the six limbs close; what follows (kshama, saptashloki) is phala-raksha, not anga."]
  },
  {
    ...
    interpretiveNotes: [
      {
        note: `${PROVENANCE} Kshama-prarthana p.723 (6 verses summarised (mula not reproduced)) followed by Devyaparadha-kshamapana-stotra p.725 ("na mantram no yantram") and Saptashloki Durga p.729 (Shiva-uvacha; 7 verses excerpted from adhyayas, closed "iti saptashloki durga sampurna").`
      }
    ],
    ...
    keyPoints: ["**Mantra-hina insurance**: What lacks mantra, rite or devotion is completed by forgiveness, not by repetition.", "**Jagadamba single-word refuge**: One uttered name outruns even the gods’ attainment."]
  },
  {
    ...
    keyPoints: ["**700 = mantra-units, not printed lines**: Ardhas and uvachas count; group-cards expand via these tables for homa.", "**Katyayani vs Yamala vs Kanva**: The edition compares all three and defends the Guptavati division with nyaya."]
  }
];
