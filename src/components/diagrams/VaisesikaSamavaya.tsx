...
<SvgText x="460" y="120" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.ink}>hand</SvgText>
<Rect x="510" y="100" width="90" height="40" rx="6" fill={colors.avyakta2} stroke={colors.rajas} strokeWidth="0.5"/>
<SvgText x="555" y="120" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.ink}>table</SvgText>
