...
export default function Samyama() {
  ...
  return (
    <Svg width="100%" viewBox="0 0 680 260" xmlns="http://www.w3.org/2000/svg" role="img">
      ...
      {inputs.map((label, i) => {
        ...
        return (
          <React.Fragment key={label}>
            ...
            <SvgText x={x + 65} y="48" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>{label}</SvgText>
      ...
      <SvgText x="340" y="168" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Saṃyama</SvgText>
      ...
      <SvgText x="581" y="162" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Insight & Siddhis</SvgText>
      <SvgText x="581" y="180" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="10.5" fill={colors.amberDim}>extraordinary powers</SvgText>
