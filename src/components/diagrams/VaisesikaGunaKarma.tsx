...
<SvgText x="180" y="62" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="16" fontWeight="500" fill={colors.ink}>Guna — attributes</SvgText>
...
<SvgText x="500" y="62" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="16" fontWeight="500" fill={colors.ink}>Karma — actions</SvgText>
