...
<SvgText x="75" y="80" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Atma</SvgText>
...
<SvgText x="231" y="80" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Manas</SvgText>
...
<SvgText x="387" y="80" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Indriya</SvgText>
...
<SvgText x="533" y="80" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Artha</SvgText>
