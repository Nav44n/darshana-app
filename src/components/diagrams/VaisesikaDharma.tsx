...
<SvgText x="140" y="130" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Dharma</SvgText>
...
<SvgText x="550" y="62" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Abhyudaya</SvgText>
<SvgText x="550" y="82" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="12" fill={colors.tealDim}>Worldly prosperity</SvgText>
<Rect x="460" y="162" width="180" height="56" rx="8" fill={colors.avyakta2} stroke={colors.rajas} strokeWidth="0.5"/>
<SvgText x="550" y="182" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Nihsreyasa</SvgText>
<SvgText x="550" y="202" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="12" fill={colors.rajasDim}>Final liberation</SvgText>
</Svg>
  );
}
