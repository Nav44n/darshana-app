...
<SvgText x="80" y="60" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.ink}>Fire</SvgText>
<Circle cx="80" cy="130" r="26" fill={colors.avyakta2} stroke={colors.sattva} strokeWidth="0.5"/>
<SvgText x="80" y="130" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.ink}>Water</SvgText>
<Circle cx="80" cy="200" r="26" fill={colors.avyakta2} stroke={colors.sattva} strokeWidth="0.5"/>
<SvgText x="80" y="200" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.ink}>Earth</SvgText>
<Circle cx="160" cy="165" r="26" fill={colors.avyakta2} stroke={colors.tamas} strokeWidth="0.5"/>
<SvgText x="160" y="165" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.ink}>Air</SvgText>
...
<SvgText x="470" y="120" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Composite substance</SvgText>
<SvgText x="470" y="142" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.purushaDim}>e.g. a jar, a body</SvgText>
</Svg>
  );
}
