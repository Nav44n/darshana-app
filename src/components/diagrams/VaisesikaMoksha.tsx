...
<SvgText x="110" y="112" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Atma</SvgText>
<Circle cx="195" cy="120" r="16" fill={colors.avyakta2} stroke={colors.amber} strokeWidth="0.5"/>
<SvgText x="195" y="120" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="10" fill={colors.ink}>Manas</SvgText>
...
<SvgText x="540" y="112" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Atma</SvgText>
<SvgText x="540" y="132" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="11" fill={colors.tealDim}>alone</SvgText>
