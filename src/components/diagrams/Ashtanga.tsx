      ...
      {outer.map((label, i) => {
        ...
        return (
          <React.Fragment key={label}>
            ...
            <SvgText x={x + bw / 2} y="64" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>{label}</SvgText>
            {i < outer.length - 1 && (
      ...
      {inner.map((label, i) => {
        ...
        return (
          <React.Fragment key={label}>
            ...
            <SvgText x={x + bw / 2} y="190" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>{label}</SvgText>
            {i < inner.length - 1 && (
