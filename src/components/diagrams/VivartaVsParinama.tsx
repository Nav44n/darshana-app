...
export default function VivartaVsParinama() {
  ...
  return (
    <Svg width="100%" viewBox="0 0 680 260">
      ...
      <SvgText x="150" y="60" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Milk</SvgText>
      <SvgText x="150" y="78" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="10.5" fill={colors.rajasDim}>the cause, really changes</SvgText>
      ...
      <SvgText x="480" y="60" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Curd</SvgText>
      <SvgText x="480" y="78" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="10.5" fill={colors.rajasDim}>a genuinely new substance</SvgText>
      ...
      <SvgText x="150" y="176" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Rope</SvgText>
      <SvgText x="150" y="194" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="10.5" fill={colors.tealDim}>Brahman, unchanged</SvgText>
      ...
      <SvgText x="480" y="176" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="13" fontWeight="500" fill={colors.ink}>Snake</SvgText>
      <SvgText x="480" y="194" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="10.5" fill={colors.tealDim}>the universe, a superimposition</SvgText>
