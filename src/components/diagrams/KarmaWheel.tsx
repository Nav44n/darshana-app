...
export default function KarmaWheel() {
  ...
  return (
    <Svg width="100%" viewBox="0 0 620 380">
      <Defs>
      ...
      <SvgText x="310" y="48" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Kleśa</SvgText>
      <SvgText x="310" y="66" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="10.5" fill={colors.tamas}>affliction</SvgText>
      ...
      <SvgText x="500" y="178" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Karma</SvgText>
      <SvgText x="500" y="196" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="10.5" fill={colors.rajasDim}>action</SvgText>
      ...
      <SvgText x="310" y="303" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Saṃskāra</SvgText>
      <SvgText x="310" y="321" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="10.5" fill={colors.rajasDim}>latent impression</SvgText>
      ...
      <SvgText x="120" y="173" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Phala</SvgText>
      <SvgText x="120" y="191" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="10.5" fill={colors.tamas}>birth, lifespan, experience</SvgText>
