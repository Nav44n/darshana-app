...
<SvgText x="150" y="102" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Threads</SvgText>
<SvgText x="150" y="124" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.tamas}>The cause, pre-existing</SvgText>
...
<SvgText x="525" y="94" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Cloth</SvgText>
<SvgText x="525" y="118" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.rajasDim}>A wholly new entity</SvgText>
<SvgText x="525" y="138" textAnchor="middle" alignmentBaseline="middle" fontFamily="sans-serif" fontSize="12" fill={colors.rajasDim}>not hidden in the threads</SvgText>
</Svg>
  );
}
