...
export default function CittaVritti() {
  ...
  return (
    <Svg width="100%" viewBox="0 0 680 240" xmlns="http://www.w3.org/2000/svg" role="img">
      ...
      <SvgText x="170" y="90" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Citta</SvgText>
      <SvgText x="170" y="112" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="11" fill={colors.rajasDim}>vṛttis fluctuating</SvgText>
      ...
      <SvgText x="500" y="110" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Puruṣa</SvgText>
      <SvgText x="500" y="132" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="11" fill={colors.purushaDim}>rests in own nature</SvgText>
