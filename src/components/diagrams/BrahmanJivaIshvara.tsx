...
export default function BrahmanJivaIshvara() {
  ...
  return (
    <Svg width="100%" viewBox="0 0 680 280" xmlns="http://www.w3.org/2000/svg" role="img">
      ...
      <SvgText x="340" y="42" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="15" fontWeight="500" fill={colors.ink}>Brahman</SvgText>
      <SvgText x="340" y="62" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="11" fill={colors.purushaDim}>the one, undivided reality</SvgText>
      ...
      <SvgText x="190" y="188" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Īśvara</SvgText>
      <SvgText x="190" y="208" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="11" fill={colors.tealDim}>Saguṇa Brahman —</SvgText>
      <SvgText x="190" y="224" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="11" fill={colors.tealDim}>creator of the universe</SvgText>

      <Rect x="390" y="160" width="200" height="90" rx="8" fill={colors.avyakta2} stroke={colors.amber} strokeWidth="0.6"/>
      <SvgText x="490" y="188" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="14" fontWeight="500" fill={colors.ink}>Jīva</SvgText>
      <SvgText x="490" y="208" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="11" fill={colors.amberDim}>the empirical self —</SvgText>
      <SvgText x="490" y="224" textAnchor="middle" dominantBaseline="central" fontFamily="sans-serif" fontSize="11" fill={colors.amberDim}>bound by mind and ignorance</SvgText>
