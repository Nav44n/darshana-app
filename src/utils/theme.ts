...
export const systemAccents: Record<string, SystemAccent> = {
  samkhya: {
    primary: '#7c3aed', // Amethyst / Puruṣa-Prakṛti discernment
    secondary: '#6d28d9',
  ...
  yoga: {
    primary: '#0d9488', // Deep teal / stillness of Citta
    secondary: '#0f766e',
  ...
  nyaya: {
    primary: '#d97706', // Saffron amber / lamp of reasoning (pradīpaḥ sarva-vidyānām)
    secondary: '#b45309',
  ...
  vaisesika: {
    primary: '#2563eb', // Royal blue / atomic ontology & categories
    secondary: '#1d4ed8',
  ...
  mimamsa: {
    primary: '#e11d48', // Carmine rose / sacred Vedic action & dharma
    secondary: '#be123c',
  ...
  vedanta: {
    primary: '#9333ea', // Imperial violet / non-dual pure consciousness
    secondary: '#7e22ce',
    bgLight: 'bg-fuchsia-50/50',
    borderLight: 'border-fuchsia-200 hover:border-fuchsia-300',
    text: 'text-fuchsia-700',
    badge: 'bg-fuchsia-100 text-fuchsia-800',
  },
  'kashmir-shaivism': {
    primary: '#d13b5f', // Spanda / Crimson pulse of Trika consciousness
    secondary: '#be123c',
    bgLight: 'bg-rose-50/50',
    borderLight: 'border-rose-200 hover:border-rose-300',
    text: 'text-rose-700',
  ...
  shakta: {
    primary: '#b91c1c', // Sacred vermilion / Mahāśakti luminous flame
    secondary: '#991b1b',
    bgLight: 'bg-red-50/50',
    borderLight: 'border-red-200 hover:border-red-300',
    text: 'text-red-700',
